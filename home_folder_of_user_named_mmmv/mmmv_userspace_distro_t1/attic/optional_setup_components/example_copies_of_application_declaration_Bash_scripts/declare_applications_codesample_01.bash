...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='15351789-369d-4cf2-834b-d0a170a04ae7'"
    echo ""
...
func_first_use_warning(){
    ...
    echo "GUID=='7414017c-afb8-41f1-b09b-d0a170a04ae7'"
    echo "Thank You."
    echo ""
...
func_declare_OpenJ9_alias_t1(){
    ...
    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
        "$MMMV_OPENJ9_HOME" "573e8ce5-95ca-4d99-9b4b-d0a170a04ae7" \
        "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        #----------------------------------------
        func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
            "$S_FP_OPENJ9_CONFIG" "8fc7bca6-1e74-4969-89eb-d0a170a04ae7" \
            "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
...
#--------------------------------------------------------------------------
    ...
    if [ "$SB_SH_EXISTS_ON_PATH" == "t" ]; then # TODO: eliminate the if-clause by updating the function below
        ...
        func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
            "$M2" "c53f5dd1-79cf-49c2-a85b-d0a170a04ae7"
        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "1a78fc74-fd92-4cce-815b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "7137dfeb-9316-42ad-8e5b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "38b342d5-49b8-42e3-8b5b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "a2e1ab21-38f9-478e-ba5b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "f278329d-0dae-4063-8b3b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "1971b875-c563-4edf-b04b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "e9e9ff93-8995-4657-864b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "c62088dd-2e20-4336-942b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "817133b6-4cae-4f8d-a11b-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "727bb38a-967c-45b2-9a7a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "e4f88ad5-9686-4105-814a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "26225c05-a4a8-4869-a62a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "830f3088-fefa-4761-911a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "942a1065-b135-4295-b0ca-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "5e57b8a3-de3a-4477-919a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "388dc895-6537-4ae8-841a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "43ca3c93-e0fa-4ab9-9c2a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "3a601612-123b-4d6c-b04a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    # func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
    #     "$S_TMP_0" "5be6fde5-43d2-4f51-ac3a-d0a170a04ae7"
    #----------------------------------------------------------------------
    S_TMP_0="$S_FP_APPLICATIONS/mmmv_hardwarethreadcount_t1"
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "2d8a0462-ad7f-42f6-8c1a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "5bdd9817-0be4-4b09-873a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "35907dc3-c1be-4c45-bf1a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "9358c4cc-00e5-436a-b84a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "29b523e5-403e-482c-ba4a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "57912364-8e8f-46a3-a43a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "d1c32ec1-e3a6-4348-ac4a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "56f8a393-dfa9-41c0-b12a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "5efee693-04ae-47a5-843a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "42ff21c0-499e-42f4-9daa-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "b85b5d71-b773-4782-a83a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "10771222-2b32-4024-9a3a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "31fb1522-e896-4004-832a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "764dd7e1-3716-4a45-a1ba-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "2c83ca52-c890-427e-bc5a-d0a170a04ae7"
    #----------------------------------------------------------------------
    S_TMP_0="$S_FP_APPLICATIONS/par2_file_corruption_mitigator/v2023_05_31"
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "0da178e2-bd5e-478b-b71a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "32be7872-ac32-4980-ad3a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "f2210009-70be-42f5-9e9a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "05f16af4-c7aa-458a-8d1a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "c1f43285-9710-474f-9d1a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "645ae438-46e2-40fd-9c5a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "4062da44-d980-4ffa-831a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "821b78c8-d159-467e-a12a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "13a57694-684f-4e87-852a-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "5e760352-8ae7-401b-9919-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "e83994b1-264c-444f-9489-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "4eb2ab34-4af6-424f-bf39-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "4c808985-93f4-4954-9c59-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "e45e40dd-6f24-43b0-a0a9-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "2362d84d-70b5-4d66-9059-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "13b73046-11c3-4a53-a529-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    #    "$S_TMP_0" "e251b525-0ac9-43ce-9c59-d0a170a04ae7"
    #if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_lib_2_LD_LIBRARY_PATH_and_include_2_CPATH_t1 \
        "$S_TMP_0" "741697f4-b9c7-4367-a629-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_lib_2_LD_LIBRARY_PATH_and_include_2_CPATH_t1 \
        "$S_TMP_0" "5feef652-9478-4572-bc29-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1 \
        "$S_TMP_0" "575582e1-7508-4c5b-8429-d0a170a04ae7"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    if [ "$SB_APPLICATION_DECLARATION_SCRIPT_CUSTOMISED" != "f" ]; then
        ...
        echo "GUID=='3b5f3ab4-52dc-4f8f-b01b-d0a170a04ae7'"
        echo ""
        # "exit 1" must not be here, because
        # an exit clause would end the login session.
    fi
    ...
    if [ -d "$S_FP_0" ]; then
        ...
        if [ -e "$S_FP_1" ]; then
            if [ ! -d "$S_FP_1" ]; then
                ...
                #     echo "GUID=='72858901-f956-4b50-b82b-d0a170a04ae7'"
                #     echo ""
                # fi
                func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
                    "$S_FP_1" "1b4706b5-2dcc-415c-8539-d0a170a04ae7" \
                    "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
            fi
        else
            ...
            if [ -h "$S_FP_1" ]; then # a broken symlink
                ...
                #     echo "GUID=='dffb830c-9d10-42c9-961b-d0a170a04ae7'"
                #     echo ""
                # fi
                func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
                    "$S_FP_1" "83b75782-ce6a-4cce-9c29-d0a170a04ae7" \
                    "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
            fi
            #--------------------------------------------------------------
        fi
        ...
        func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
            "$S_FP_0" "8a4cd135-5d24-4394-8849-d0a170a04ae7" \
            "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
    fi
fi
#==========================================================================
# S_VERSION_OF_THIS_FILE="a3119617-7085-44ac-a049-d0a170a04ae7"
#==========================================================================
