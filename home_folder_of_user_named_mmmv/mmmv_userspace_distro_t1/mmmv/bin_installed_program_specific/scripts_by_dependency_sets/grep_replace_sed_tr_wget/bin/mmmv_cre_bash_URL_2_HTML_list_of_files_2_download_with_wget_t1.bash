...
#     Copy of the test.html that was used for developing this script.
#
#==========================================================================
...
func_mmmv_bash_boilerplate_version(){
    local S_GUID="d6c4e7be-cc25-4581-9896-83234030a9e7"
...
func_mmmv_init_s_timestamp_if_not_inited_t1(){
    if [ "$S_TIMESTAMP" == "" ]; then
        if [ "`which date 2> /dev/null`" != "" ]; then
            ...
            echo ""
            echo "GUID=='93d02f12-8dc3-41e1-a296-83234030a9e7'"
            echo ""
        fi
    fi
} # func_mmmv_init_s_timestamp_if_not_inited_t1
...
func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1(){
    ...
    if [ "$S_FP_ORIG" == "" ]; then
        ...
        echo "GUID=='21767883-606e-45c0-b296-83234030a9e7'"
        echo ""
    else
        if [ ! -e "$S_FP_ORIG" ]; then
            SB_S_FP_ORIG_VERIFICATION_FAILED="t"
            ...
            echo ""
            echo "GUID=='34b6a547-5398-47a4-8496-83234030a9e7'"
            echo ""
        else
            if [ ! -d "$S_FP_ORIG" ]; then
                SB_S_FP_ORIG_VERIFICATION_FAILED="t"
                ...
                echo "    S_FP_ORIG==$S_FP_ORIG"
                echo ""
                echo "GUID=='e4f08326-7313-432c-9496-83234030a9e7'"
                echo ""
            fi
        fi
    fi
    ...
    #        echo "GUID=='03780927-3142-4e7e-8486-83234030a9e7'"
    #        echo ""
    #    fi
} # func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1
...
func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t2(){
    if [ "$SB_FUNC_MMMV_VERIFY_S_FP_ORIG_BUT_DO_NOT_EXIT_T2_S_FB_ORIG_ALREADY_VERIFIED" != "t" ]; then
        if [ "$SB_FUNC_MMMV_VERIFY_S_FP_ORIG_BUT_DO_NOT_EXIT_T2_S_FB_ORIG_ALREADY_VERIFIED" != "f" ]; then
            ...
            echo "GUID=='167b2fe1-62f5-4d62-b186-83234030a9e7'"
            echo ""
        else
            func_mmmv_verify_S_FP_ORIG_but_do_not_exit_t1
...
func_mmmv_assert_nonempty_string_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='02d28b33-961e-4037-b476-83234030a9e7'"
        echo ""
    ...
    if [ "$SB_NO_ERRORS_YET" != "t" ]; then
        ...
        if [ "$SB_NO_ERRORS_YET" == "f" ]; then
            ...
            echo "GUID=='079a5b21-0fda-4075-9176-83234030a9e7'"
        else
            echo "is expected to be initialized to \"t\" before calling this function"
            echo "and its domain is {\"f\", \"t\"}."
            echo "GUID=='2d62c56a-7bdb-4d63-8576-83234030a9e7'"
        fi
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then
        if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then
            ...
            echo ""
            echo "GUID=='272c7543-4a8c-447c-a166-83234030a9e7'"
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then
        if [ "$S_IN" == "" ]; then
            ...
            echo "GUID=='092d6151-48d2-48f6-8566-83234030a9e7'"
            if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
            echo ""
...
func_mmmv_assert_sbvar_domain_t_f_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='742fd63c-daec-4707-a366-83234030a9e7'"
        echo ""
        SB_NO_ERRORS_YET_1="f"
    fi
    #--------------------
    if [ "$SB_NO_ERRORS_YET" != "t" ]; then
        ...
        if [ "$SB_NO_ERRORS_YET" == "f" ]; then
            echo "is expected to be initialized to \"t\" before calling this function."
            echo "GUID=='d9b82357-17f9-4a3f-8566-83234030a9e7'"
        else
            echo "is expected to be initialized to \"t\" before calling this function"
            echo "and its domain is {\"f\", \"t\"}."
            echo "GUID=='46ca6a24-089e-4a1e-ac56-83234030a9e7'"
        fi
        if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then
            echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        fi
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then
        if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then
            ...
            echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
            echo ""
            echo "GUID=='27057a14-8c75-4c08-b456-83234030a9e7'"
            if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
            echo ""
    ...
    if [ "$SB_NO_ERRORS_YET" == "t" ]; then
        if [ "$SB_VARIABLE_VALUE" != "t" ]; then
            if [ "$SB_VARIABLE_VALUE" != "f" ]; then
                ...
                echo "GUID=='432b8c42-e8ed-4ed8-b256-83234030a9e7'"
                if [ "$SB_NO_ERRORS_YET_1" == "t" ]; then  # should be always true at this line
                    echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                fi
                echo ""
...
func_mmmv_report_an_error_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='59fe34f0-62ab-4e39-a346-83234030a9e7'"
        echo ""
    else
        echo ""
        echo -e "\e[31mThe code of this script is flawed.\e[39m"
        ...
        echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo "GUID=='558a491a-f90e-4a86-9346-83234030a9e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
    # exit 1 # must NOT be called in ~/.bashrc, because
...
func_mmmv_report_missing_from_path_and_do_NOT_exit_t1() {
    ...
    if [ "$S_TMP_1" == "" ] ; then
        ...
        echo "GUID=='d28e5185-849d-4de8-b346-83234030a9e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
    # exit 1 # must NOT be called in ~/.bashrc, because
...
func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1() {  # S_FP, S_GUID_CANDIDATE
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='b211fd46-3370-4018-8146-83234030a9e7'"
        echo ""
        #--------
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "" ]; then
            if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" == "f" ]; then
                ...
                if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "t" ]; then
                    ...
                    echo "\"\" defaults to \"t\"."
                    echo "GUID=='e685ea36-0320-4142-a436-83234030a9e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
        ...
        if [ ! -e "$S_FP" ]; then
            if [ -h "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID=='55b94236-6bce-424c-a436-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
                ...
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='a2a2da24-6271-4a63-b336-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
            ...
            if [ -d "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='3e6bbbd2-c094-440c-b236-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            ...
            echo "GUID=='c2336630-4833-4ecb-9426-83234030a9e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1() {  # S_FP, S_GUID_CANDIDATE
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "This function requires 2 parameters: S_FP, S_GUID_CANDIDATE"
        echo "and has an optional 3. parameter: SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE"
        echo "GUID=='52eb7695-0a0f-4210-9826-83234030a9e7'"
        echo ""
        #--------
        SB_VERIFICATION_FAILED="t"
    fi
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "" ]; then
            if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" == "f" ]; then
                ...
                if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE" != "t" ]; then
                    ...
                    echo "Valid values are: \"t\", \"f\", \"\" ."
                    echo "\"\" defaults to \"t\"."
                    echo "GUID=='f6b50012-c1dd-4730-9126-83234030a9e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
        ...
        if [ ! -e "$S_FP" ]; then
            if [ -h "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='17aa9319-1ee7-4493-9316-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
                ...
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo -e "\e[31mdoes not exist\e[39m."
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='a3b2cd52-0cfd-4950-8416-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
            ...
            if [ ! -d "$S_FP" ]; then
                if [ "$SB_DISPLAY_VERIF_FAILURE_MSG" == "t" ]; then
                    ...
                    echo "GUID==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='2f51a863-a387-4a5b-a616-83234030a9e7'"
                    echo ""
                fi
                #--------
                SB_VERIFICATION_FAILED="t"
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash function is flawed.\e[39m"
            echo "GUID=='951e291b-6439-4cb1-9416-83234030a9e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_add_bin_2_Z_PATH_and_optionally_share_man_2_MANPATH_t1(){
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        if [ "$S_GUID_CANDIDATE" == "" ]; then
            ...
            echo "    S_GUID_CANDIDATE==\"\""
            echo ""
            echo "GUID=='13c28e61-6577-4577-ae06-83234030a9e7'"
            echo ""
            #--------
            SB_VERIFICATION_FAILED="t"
        fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        if [ "$S_FP_INSTALLATION_FOLDER" == "" ]; then
            ...
            echo "GUID=='c8dd4005-172f-41ec-aa06-83234030a9e7'"
            echo ""
            #--------
            SB_VERIFICATION_FAILED="t"
        fi
        ...
        if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" == "" ]; then
            ...
            if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" != "t" ]; then
                if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" != "f" ]; then
                    ...
                    echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                    echo "GUID=='9e707022-3fc0-4dc9-be06-83234030a9e7'"
                    echo ""
                    #--------
                    SB_VERIFICATION_FAILED="t"
                fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
            "$S_FP_INSTALLATION_FOLDER" "44b7be5d-4385-4554-a296-83234030a9e7"
        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
            #--------------
            func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                "$S_FP_INSTALLATION_FOLDER/bin" "110480c3-bed5-41ca-8196-83234030a9e7"
            if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
            ...
            if [ "$SB_MAN_FOLDER_OR_NONBROKEN_SYMLINK_TO_IT_EXISTS" == "f" ]; then
                if [ "$SB_MAN_FOLDER_EXISTENCE_IS_MANDATORY" == "t" ]; then
                    ...
                    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                        "$S_FP_INSTALLATION_FOLDER/share/man" "48cee474-0b54-4c2b-8c86-83234030a9e7"
                fi
            else
    ...
    if [ "$SB_VERIFICATION_FAILED" != "t" ]; then
        if [ "$SB_VERIFICATION_FAILED" != "f" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash function is flawed.\e[39m"
            echo "GUID=='36337cd2-f2ae-4521-93f5-83234030a9e7'"
            echo ""
        fi
    fi
    #------------------------------
...
func_mmmv_assert_error_code_zero_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='9e11d741-4378-41ba-85f5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_ERR_CODE" != "0" ];then
        ...
        echo "GUID=='2ec50652-bbc0-4f32-96f5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_error_code_zero_t2(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='7ac7b843-1fec-4925-b1f5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        exit 1
    ...
    if [ "$S_ERR_CODE" != "0" ];then
        ...
        echo "Something went wrong. Error code: $S_ERR_CODE"
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='4777d8d1-95f7-4f01-a1e5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        exit 1
...
func_mmmv_exc_verify_S_FP_ORIG_t1() {
    if [ "$S_FP_ORIG" == "" ]; then
        ...
        echo ""
        echo "Aborting script."
        echo "GUID=='50525b37-bc3c-4910-81e5-83234030a9e7'"
        echo ""
    ...
    if [ ! -e "$S_FP_ORIG" ]; then
        ...
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='327d7ff3-10e1-48b9-85e5-83234030a9e7'"
        echo ""
        exit 1 # exit with an error
    fi
    #------------------------
    if [ ! -d "$S_FP_ORIG" ]; then
        ...
        echo "contains the script that prints this error message."
        echo -e "\e[31mAborting script. \e[39m"
        echo "GUID=='6b70cb1a-cb91-4ecf-94e5-83234030a9e7'"
        echo ""
        exit 1 # exit with an error
    fi
} # func_mmmv_exc_verify_S_FP_ORIG_t1
...
func_mmmv_exc_verify_S_FP_ORIG_t2(){
    if [ "$FUNC_MMMV_EXC_VERIFY_S_FP_ORIG_T2_S_FB_ORIG_ALREADY_VERIFIED" != "t" ]; then
        if [ "$FUNC_MMMV_EXC_VERIFY_S_FP_ORIG_T2_S_FB_ORIG_ALREADY_VERIFIED" != "f" ]; then
            ...
            echo ""
            echo "has a domain of {\"f\", \"t\"}."
            echo "GUID=='b24abb17-6aa2-4005-93d5-83234030a9e7'"
            echo ""
        else
            func_mmmv_exc_verify_S_FP_ORIG_t1
...
func_mmmv_cd_S_FP_ORIG_and_exit_t1(){
    ...
    cd "$S_FP_ORIG"
    func_mmmv_assert_error_code_zero_t2 "$?" \
        "e9cb8844-99f7-48e1-9586-83234030a9e7"
    exit 0
} # func_mmmv_cd_S_FP_ORIG_and_exit_t1
...
func_mmmv_assert_nonempty_string_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='67896d54-0cb8-480d-a5d5-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then
        ...
        echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
        echo ""
        echo "GUID=='5dceedf4-f51b-409b-91d5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_IN" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be something other than an empty string."
        echo "GUID=='95786d7b-ff16-4b00-91d5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_sbvar_domain_t_f_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='35fb5b88-4664-4e7c-b3c5-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    if [ "$S_VARIABLE_NAME_IN_CALLING_CODE" == "" ]; then
        ...
        echo "    S_VARIABLE_NAME_IN_CALLING_CODE==\"\""
        echo ""
        echo "GUID=='14412b7d-f1c0-42f0-b2c5-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$SB_VARIABLE_VALUE" != "t" ]; then
        if [ "$SB_VARIABLE_VALUE" != "f" ]; then
            ...
            echo ""
            echo "but it is expected to be either \"t\" or \"f\"."
            echo "GUID=='562a1b3e-3138-4b91-91c5-83234030a9e7'"
            echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
...
func_mmmv_assert_file_exists_t1() {
    ...
    if [ "$SB_LACK_OF_PARAMETERS" == "t" ]; then
        ...
        echo "GUID=='28116282-97f5-4a2f-86b5-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
        ...
        if [ "$SB_LACK_OF_PARAMETERS" != "f" ]; then
            ...
            echo "GUID=='4c3ec619-b059-4013-b4b5-83234030a9e7'"
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        fi
    ...
    if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "" ]; then
        ...
        if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "t" ]; then
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "f" ]; then
                ...
                echo "are: \"t\", \"f\", \"\"."
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                echo "GUID=='d4d30a3c-f6e2-4614-a2b5-83234030a9e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP" ]; then
        if [ -h "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='d7d05a10-fda7-4798-b5b5-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            echo -e "\e[31mdoes not exist\e[39m."
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='2104dd22-9788-4749-95a5-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        ...
        if [ -d "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='55c0f282-3321-4dc5-82a5-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "t" ]; then
                if [ -h "$S_FP" ]; then
                    ...
                    echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='16431f55-ffd9-4564-82a5-83234030a9e7'"
                    echo ""
                    #--------
                    cd "$S_FP_ORIG"
                    exit 1 # exiting with an error
...
func_mmmv_assert_folder_exists_t1() {
    ...
    if [ "$SB_LACK_OF_PARAMETERS" == "t" ]; then
        ...
        echo "GUID=='429a3264-0cf0-445d-a8a5-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
        ...
        if [ "$SB_LACK_OF_PARAMETERS" != "f" ]; then
            echo -e "\e[31mThis code is flawed. \e[39m"
            echo "GUID=='3185892c-38f7-4bae-9195-83234030a9e7'"
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        fi
    ...
    if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "" ]; then
        ...
        if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "t" ]; then
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" != "f" ]; then
                ...
                echo "are: \"t\", \"f\", \"\"."
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
                echo "GUID=='2a81372a-ca67-4575-b595-83234030a9e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP" ]; then
        if [ -h "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='da2f5611-3ac2-4cfd-b595-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            echo -e "\e[31mdoes not exist\e[39m."
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='26416854-6154-4734-b795-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
        ...
        if [ ! -d "$S_FP" ]; then
            ...
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo "GUID=='7049d321-7d7a-4205-9585-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
            ...
            if [ "$SB_OPTIONAL_BAN_SYMLINKS" == "t" ]; then
                if [ -h "$S_FP" ]; then
                    ...
                    echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                    echo "GUID=='1427cfa4-1b0e-4693-b185-83234030a9e7'"
                    echo ""
                    #--------
                    cd "$S_FP_ORIG"
                    exit 1 # exiting with an error
...
func_mmmv_exit_if_not_on_path_t2() { # S_COMMAND_NAME
    ...
    if [ "$S_LOCAL_VARIABLE" == "" ]; then
        ...
        echo "GUID=='a7c6112c-7a34-48a4-b485-83234030a9e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1;
    fi
...
func_mmmv_exc_exit_with_an_error_t1(){
    ...
    echo "GUID=='e7a92750-0629-4988-9375-83234030a9e7'"
    echo ""
    cd "$S_FP_ORIG"
    exit 1 # exit with an error
} # func_mmmv_exc_exit_with_an_error_t1
...
func_mmmv_exc_exit_with_an_error_t2(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='8e21f52b-658d-41dc-9575-83234030a9e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    else
        ...
        echo "Aborting script."
        echo "GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo "GUID=='a6372236-8a9d-4fc1-8475-83234030a9e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
...
func_mmmv_exc_determine_Awk_command_t1() { # prefers the GNU Awk to the BSD Awk
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" != "" ]; then
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            ...
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "f240b413-06ec-4cfd-a176-83234030a9e7"
    ...
    if [ "$SB_REINIT" == "t" ]; then
        ...
        local SB_THROW="f"
        local S_TMP_0="6cbc556f-f28e-409e-b476-83234030a9e7"
        ...
        if [ "$SB_THROW" == "t" ]; then
            ...
            echo "The execution of this Bash script is aborted."
            echo "GUID=='1ff42c63-7b6b-402f-8375-83234030a9e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1;
        fi
...
func_mmmv_exc_determine_sed_command_t1() { # prefers the GNU sed to the BSD sed
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" != "" ]; then
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "876f981b-921b-4d25-b576-83234030a9e7"
        SB_AVOID_REINIT="$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED"
    fi
    #----------------------------------------------------------------------
    local SB_REINIT="t"
    ...
    if [ "$SB_REINIT" == "t" ]; then
        ...
        local SB_THROW="f"
        local S_TMP_0="37eab93d-0ffe-414c-9476-83234030a9e7"
        local S_FP_0="/tmp/this/proB9bably/do00es/noTt/eXXXist/ㄫ/$S_TMP_0"
        #------------------------------------------------------------------
        ...
        if [ "$SB_THROW" != "f" ]; then
            ...
            echo "The execution of this Bash script is aborted."
            echo "GUID=='6260c619-b5b5-4be4-8575-83234030a9e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1;
        fi
...
func_mmmv_exc_is_file_t1() {
    ...
    if [ ! -e "$S_FP_CANDIDATE" ]; then
        ...
        echo ""
        echo -e "\e[31mdoes not exist\e[39m."
        echo "GUID=='3bf551e6-a1d8-4390-a275-83234030a9e7'"
    ...
    if [ -d "$S_FP_CANDIDATE" ]; then
        ...
        echo "GUID=='9b2dbf5d-5989-4e76-8565-83234030a9e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_exc_is_folder_t1() {
    ...
    if [ ! -e "$S_FP_CANDIDATE" ]; then
        ...
        echo ""
        echo -e "\e[31mdoes not exist\e[39m."
        echo "GUID=='bf3bc726-328d-403d-8565-83234030a9e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
    if [ ! -d "$S_FP_CANDIDATE" ]; then
        ...
        echo "GUID=='920cd64a-d6fd-4210-b565-83234030a9e7'"
        echo "Aborting without doing anything."
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_create_folder_t1(){
    ...
    if [ "$S_FP_FOLDER" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='4eb68c33-9f3a-46ce-8465-83234030a9e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
    ...
    if [ -e "$S_FP_FOLDER" ]; then
        if [ ! -d "$S_FP_FOLDER" ]; then
            ...
            echo "Aborting script."
            echo "GUID=='3d92711a-4360-4310-b165-83234030a9e7'"
            echo ""
            cd "$S_FP_ORIG"
            exit 1 # exit with an error
        fi
        ...
        wait # just in case
        if [ "$S_TMP_0" != "0" ]; then
            func_mmmv_exc_exit_with_an_error_t2 "22cf02d1-f6f4-4a7c-9166-83234030a9e7" \
                "S_FP_FOLDER==$S_FP_FOLDER"
        fi
        if [ ! -e "$S_FP_FOLDER" ]; then
            func_mmmv_exc_exit_with_an_error_t2 "8ae54b1c-0a2a-4a18-9366-83234030a9e7" \
...
func_mmmv_exc_assure_tmp_folder_existence_t1() {  # S_FP_TMP, S_GUID
    ...
    if [ "$S_GUID" == "" ]; then
        ...
        echo "GUID=='6427e638-c9ad-4609-9165-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    if [ ! -e "$S_FP_TMP" ]; then
        if [ -h "$S_FP_TMP" ]; then
            ...
            func_mmmv_assert_error_code_zero_t1 \
                "$?" "400dfab7-25d3-4149-a366-83234030a9e7"
            func_mmmv_wait_and_sync_t1
            if [ -h "$S_FP_TMP" ]; then
                echo ""
                echo "The path "
                ...
                echo "GUID==\"$S_GUID\""
                echo "GUID=='7ce2953c-5f8b-429f-8165-83234030a9e7'"
                echo ""
                #--------
                cd "$S_FP_ORIG"
                exit 1 # exiting with an error
        ...
        mkdir -p "$S_FP_TMP"
        func_mmmv_assert_error_code_zero_t1 \
            "$?" "249a55f5-a608-478e-bc56-83234030a9e7"
        func_mmmv_wait_and_sync_t1
        func_mmmv_assert_folder_exists_t1 "$S_FP_TMP" \
            '51f4af5c-be24-441d-9265-83234030a9e7'
    else
        if [ ! -d "$S_FP_TMP" ]; then
            echo ""
            if [ -h "$S_FP_TMP" ]; then
            ...
            echo "GUID==\"$S_GUID\""
            echo "GUID=='dfd74959-57ca-43f6-a265-83234030a9e7'"
            echo ""
            #--------
            cd "$S_FP_ORIG"
            exit 1 # exiting with an error
...
func_mmmv_ln_create_hardlink_t1() { # S_FP_TARGET  S_FP_LINK
    ...
    if [ "$SB_THROW_ON_INVALID_DATA" == "" ]; then
        ...
        if [ "$SB_THROW_ON_INVALID_DATA" != "t" ]; then
            if [ "$SB_THROW_ON_INVALID_DATA" != "f" ]; then
                ...
                echo ""
                echo "Aborting script."
                echo "GUID=='49d5951b-9218-411e-9165-83234030a9e7'"
                echo ""
    ...
    if [ -e "$S_FP_LINK" ]; then
        if [ -d "$S_FP_LINK" ]; then # folder or a symlink to a folder
            if [ ! -h "$S_FP_LINK" ]; then # not a symlink, therefore a folder
                ...
                echo "    $S_FP_TARGET"
                echo ""
                echo "GUID=='b0be9e5c-7239-4762-a365-83234030a9e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            ...
            echo "GUID=='4e341914-7e4f-42a8-8165-83234030a9e7'"
            echo ""
            if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                exit 1
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            if [ -h "$S_FP_LINK" ]; then # a broken symlink, therefore NOT missing
                ...
                echo "must not exist before the call to this function."
                echo "GUID=='cd477d43-2595-44a0-a365-83234030a9e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
        ...
        if [ -e "$S_FP_TARGET" ]; then
            if [ -d "$S_FP_TARGET" ]; then # a folder or a symlink to a folder
                if [ ! -h "$S_FP_TARGET" ]; then # not a symlink, therefore a folder
                    ...
                    echo "    $S_FP_LINK"
                    echo ""
                    echo "GUID=='44e5c373-e441-4f27-b765-83234030a9e7'"
                    echo ""
                    if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                        exit 1
                    fi
            ...
            if [ ! -h "$S_FP_TARGET" ]; then # not a symlink, therefore missing
                ...
                echo "    $S_FP_LINK"
                echo ""
                echo "GUID=='53d8ee1c-6fa6-4085-8365-83234030a9e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
    ...
    #----------------------------------------------------------------------
    local S_TMP_0="not_set_yet GUID=='33a71914-0f3a-48a7-8265-83234030a9e7'"
    if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
        ...
        if [ "$S_TMP_0" != "0" ]; then
            ...
            echo "GUID=='d077bd33-71e0-4908-b565-83234030a9e7'"
            echo ""
            if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                exit 1
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" == "f" ]; then
            ...
            if [ -h "$S_FP_TARGET" ]; then
                ...
                if [ ! -h "$S_FP_LINK" ]; then
                    ...
                    echo "GUID=='61a76824-5b7e-4b78-8565-83234030a9e7'"
                    echo ""
                    S_TMP_0="t"
                else
                    if [ -e "$S_FP_TARGET" ]; then # symlink to a folder or a file
                        if [ ! -e "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='8b535c35-c2ef-437c-a465-83234030a9e7'"
                            echo ""
                            S_TMP_0="t"
                        else
                            if [ -d "$S_FP_TARGET" ]; then
                                if [ ! -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='ab0ab112-f39d-4f5f-9255-83234030a9e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            else
                                if [ -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='aced471f-a5b4-427b-8155-83234030a9e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            fi
                        ...
                        if [ -e "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='92a64e0c-b833-4adf-9255-83234030a9e7'"
                            echo ""
                            S_TMP_0="t"
                        fi
                    fi
                ...
                if [ ! -e "$S_FP_TARGET" ]; then # just an extra test
                    echo ""
                    echo "Problem detection branch marker "
                    echo "GUID=='c53bc529-aba4-420f-b355-83234030a9e7'"
                    echo ""
                    S_TMP_0="t"
                else
                    if [ -d "$S_FP_TARGET" ]; then # just an extra test
                        echo ""
                        echo "Problem detection branch marker "
                        echo "GUID=='be40f51c-6a47-4c1a-9255-83234030a9e7'"
                        echo ""
                        S_TMP_0="t"
                    else
                        if [ -h "$S_FP_LINK" ]; then
                            echo ""
                            echo "Problem detection branch marker "
                            echo "GUID=='22b55120-7ca5-4280-a155-83234030a9e7'"
                            echo ""
                            S_TMP_0="t"
                        else
                            if [ ! -e "$S_FP_LINK" ]; then
                                echo ""
                                echo "Problem detection branch marker "
                                echo "GUID=='a48753bf-14e9-47d0-9c55-83234030a9e7'"
                                echo ""
                                S_TMP_0="t"
                            else
                                if [ -d "$S_FP_LINK" ]; then
                                    echo ""
                                    echo "Problem detection branch marker "
                                    echo "GUID=='31938c42-0b4c-4c69-9355-83234030a9e7'"
                                    echo ""
                                    S_TMP_0="t"
                                fi
                            fi
            ...
            if [ "$S_TMP_0" == "t" ]; then
                ...
                echo "GUID=='449fe312-49f7-499b-b355-83234030a9e7'"
                echo ""
                if [ "$SB_THROW_ON_INVALID_DATA" == "t" ]; then
                    exit 1
                fi
                ...
                if [ "$S_TMP_0" != "f" ]; then
                    ...
                    echo "Aborting script."
                    echo "GUID=='907e652b-8e2b-4a35-9355-83234030a9e7'"
                    echo ""
                    exit 1
                fi
            fi
        ...
        if [ "$SB_DO_NOT_CREATE_THE_HARDLINK" != "t" ]; then
            ...
            echo -e "\e[31mThe implementation of this function is flawed. \e[39m"
            echo "Aborting script."
            echo "GUID=='8ff89dca-1ddd-4921-9555-83234030a9e7'"
            echo ""
            exit 1
        fi
    fi
...
func_mmmv_assert_environment_variable_set_t1() {
    ...
    if [ "$S_ENVIR_VALUE" == "" ]; then
        ...
        echo "GUID=='603580d4-e069-47f5-9855-83234030a9e7'"
        echo ""
        exit 1 # exit with an error
    #else
...
func_mmmv_iterate_over_array_02n_t1() {
    ...
    if [ "$S_ARRAY_VARIABLE_NAME" == "" ]; then
        ...
        echo "GUID=='a48c8c4b-bbf5-4e5d-b455-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$S_ITERATION_FUNCTION_NAME" == "" ]; then
        ...
        echo "GUID=='517fc147-5677-46f2-a155-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
...
func_mmmv_include_bashfile_if_possible_t1(){ # S_FP_BASHFILE S_GUID_CANDIDATE SB_THROW_ON_ERROR
    ...
    if [ "$SB_THROW_ON_ERROR" == "" ]; then
        ...
        if [ "$SB_THROW_ON_ERROR" != "t" ]; then
            if [ "$SB_THROW_ON_ERROR" != "f" ]; then
                ...
                echo "GUID=='9ec1b24f-25a7-4fa9-b455-83234030a9e7'"
                echo ""
            fi
        fi
    fi
    ...
    if [ "$S_FP_BASHFILE" == "" ]; then
        ...
        echo "GUID=='2e329929-0dfc-42ec-8555-83234030a9e7'"
        echo ""
        if [ "$SB_THROW_ON_ERROR" == "t" ]; then
            exit 1
        fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ ! -e "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='cf32db23-03bb-44ec-b255-83234030a9e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1
            fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ -d "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='3108b220-5933-42b3-a555-83234030a9e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1
            fi
    ...
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        ...
        if [ "$SB_INCLUSION_POSSIBLE" != "f" ]; then
            ...
            echo "GUID=='4763246b-ccb3-4878-9445-83234030a9e7'"
            echo ""
            if [ "$SB_THROW_ON_ERROR" == "t" ]; then
                exit 1
            fi
...
func_mmmv_include_bashfile_if_possible_t2(){ # S_FP_BASHFILE S_GUID_CANDIDATE
    ...
    if [ "$S_FP_BASHFILE" == "" ]; then
        ...
        echo "GUID=='968a9234-29ff-4ec0-b145-83234030a9e7'"
        echo ""
    fi
    #-----------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ ! -e "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='1274a072-11eb-41ac-bb45-83234030a9e7'"
            echo ""
        fi
    fi
    #-----------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        if [ -d "$S_FP_BASHFILE" ]; then
            ...
            echo "GUID=='f1a52be8-42ed-4fd7-9e45-83234030a9e7'"
            echo ""
        fi
    fi
    #----------------------------------------------------------------------
    if [ "$SB_INCLUSION_POSSIBLE" == "t" ]; then
        ...
        if [ "$SB_INCLUSION_POSSIBLE" != "f" ]; then
            ...
            echo "GUID=='36c85ed3-a7db-413f-a545-83234030a9e7'"
            echo ""
        fi
    fi
...
func_mmmv_assert_exists_on_path_t1() {
    ...
    if [ "$S_TMP_1" == "" ]; then
        ...
        echo "GUID=='2af4b94a-8f2f-4ed3-9245-83234030a9e7'"
        echo ""
        cd "$S_FP_ORIG"
        exit 1 # exit with an error
    fi
...
func_mmmv_ln_create_or_overwrite_symlink_t1() { # S_FP_TARGET  S_FP_LINK
    ...
    if [ -e "$S_FP_LINK" ]; then
        if [ ! -h "$S_FP_LINK" ]; then # not a symlink
            ...
            echo ""
            echo "PWD==`pwd`"
            echo "GUID=='5162cc25-962c-4c68-a545-83234030a9e7'"
            echo ""
            exit 1 # exit with an error
        fi
    ...
    if [ "$SB_DELETE_OLD_LINK" == "t" ]; then
        rm -f $S_FP_LINK
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "6e43d91c-41b8-49d0-b356-83234030a9e7"
        func_mmmv_wait_and_sync_t1
        if [ -e "$S_FP_LINK" ]; then
            echo ""
            echo ""
            ...
            echo ""
            echo "PWD==`pwd`"
            echo "GUID=='b2a73b39-ab97-4bfa-b445-83234030a9e7'"
            echo ""
            echo ""
            exit 1 # exit with an error
        fi
    ...
    $S_CMD_LN
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "28364931-286b-42b1-b456-83234030a9e7"
    func_mmmv_wait_and_sync_t1
    if [ ! -e "$S_FP_LINK" ]; then
        echo ""
        echo ""
        ...
        echo ""
        echo "PWD==`pwd`"
        echo "GUID=='30701322-b37c-4991-8545-83234030a9e7'"
        echo ""
        echo ""
        exit 1 # exit with an error
    fi
...
func_mmmv_determine_operatingsystem_t1() {
    ...
    if [ "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "SB_AVOID_REINITIALISATION_IF_ALREADY_INITIALIZED" \
            "18060210-cd0f-4282-a256-83234030a9e7"
    fi
...
func_mmmv_assert_Linux_or_BSD_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "GUID=='510683ad-d16a-46b9-8345-83234030a9e7'"
        echo ""
        # if [ "$S_FP_ORIG" != "" ]; then
        #     func_mmmv_exc_verify_S_FP_ORIG_t1
        #     cd "$S_FP_ORIG"
    ...
    if [ "$S_TMP_0" == "" ]; then
        ...
        echo ""
        echo "GUID=='1ccf27ab-5dc1-4c25-8145-83234030a9e7'"
        echo ""
        # if [ "$S_FP_ORIG" != "" ]; then
        #     func_mmmv_exc_verify_S_FP_ORIG_t1
        #     cd "$S_FP_ORIG"
...
func_mmmv_verify_that_internet_connection_exists_but_do_not_exit_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo ""
        echo "but it is expected to be a GUID."
        echo "GUID=='208901ce-6c33-4cd2-8245-83234030a9e7'"
        echo ""
    fi
    #----------------------------------------------------------------------
            ...
            if [ "$SB_DISPLAY_NONERROR_FEEDBACK" != "f" ]; then
                ...
                if [ "$S_GUID_CANDIDATE" != "" ]; then
                    ...
                    func_mmmv_assert_sbvar_domain_t_f_but_do_not_exit_t1 \
                        "$SB_DISPLAY_NONERROR_FEEDBACK" \
                        "SB_DISPLAY_NONERROR_FEEDBACK" \
                        "314cac32-841d-41bf-8146-83234030a9e7"
                fi
                SB_DISPLAY_NONERROR_FEEDBACK="f"
                #----------------------------------------
            fi
...
# RENESSAATOR_BLOCK_END
    ...
    if [ "$SB_DOMAIN_IS_REACHABLE" == "f" ]; then
        ...
        if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "t" ]; then
            ...
            echo "GUID=='59b708ac-32e6-4a0b-b545-83234030a9e7'"
            if [ "$S_GUID_CANDIDATE" != "" ]; then
                echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
            fi
        fi
...
func_mmmv_assert_internet_connection_exists_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='9a4fad32-84a8-477b-b345-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$SB_OK_TO_CACHE" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            ...
            "7dc5a730-1752-485d-9346-83234030a9e7"
    fi
    #----------------------------------------------------------------------
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        SB_DISPLAY_NONERROR_FEEDBACK="f"
    ...
    if [ "$SB_STUDY_INTERNET_AVAILABILITY" == "t" ]; then
        ...
        # The
        func_mmmv_verify_that_internet_connection_exists_but_do_not_exit_t1 \
            "88a5384d-5313-4bf2-9336-83234030a9e7" \
            "$SB_DISPLAY_NONERROR_FEEDBACK"
        ...
        if [ "$SB_VERIFICATION_FAILED" == "t" ]; then
            ...
            if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
                ...
                func_mmmv_assert_sbvar_domain_t_f_t1 \
                    ...
                    "SB_VERIFICATION_FAILED" \
                    "9dd83b47-b331-48e4-8536-83234030a9e7"
            fi
        fi
        #----------------------------------------
    ...
    if [ "$SB_INTERNET_AVAILABLE" == "f" ]; then
        ...
        echo "GUID=='23d84ce2-ca20-40a2-b745-83234030a9e7'"
        echo "S_GUID_CANDIDATE=='$S_GUID_CANDIDATE'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_mmmv_assert_GUI_applications_can_be_launched_t1(){
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='acbdbc31-fb3f-4781-9645-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$SB_OK_TO_CACHE" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_OK_TO_CACHE" "SB_OK_TO_CACHE" \
            "7cb95630-54d6-4892-b426-83234030a9e7"
    fi
    #----------------------------------------------------------------------
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        SB_DISPLAY_NONERROR_FEEDBACK="f"
    ...
    if [ "$SB_OK_TO_CACHE" == "t" ]; then
        if [ "$SB_FUNC_MMMV_ASSERT_GUI_APPLICATIONS_CAN_BE_LAUNCHED_T1_RESULT_CACHED" == "t" ]; then
            ...
            if [ "$SB_FUNC_MMMV_ASSERT_GUI_APPLICATIONS_CAN_BE_LAUNCHED_T1_GUI_IS_LAUNCHABLE" == "f" ]; then
                ...
                echo "Aborting script."
                echo "GUID=='0b57281c-a586-4b38-b545-83234030a9e7'"
                echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
                echo ""
                #--------
                cd "$S_FP_ORIG"
    ...
    if [ "$SB_RUN_TEST" == "t" ]; then
        ...
        if [ "$S_TMP_0" != "124" ]; then
            ...
            echo "Aborting script."
            echo "GUID=='43acae26-ff38-4600-9245-83234030a9e7'"
            echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
            echo ""
            #--------
            cd "$S_FP_ORIG"
...
func_mmmv_exc_initialize_wine_C_drive_if_needed_t1(){
    ...
    if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "" ]; then
        ...
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            "$SB_DISPLAY_NONERROR_FEEDBACK" "SB_DISPLAY_NONERROR_FEEDBACK" \
            "9667fa23-2ff7-4c58-b416-83234030a9e7"
    fi
    #----------------------------------------------------------------------
    ...
    if [ ! -d "$S_FP_C" ]; then # for speed optimisation
        if [ ! -e "$S_FP_C" ]; then
            ...
            func_mmmv_assert_GUI_applications_can_be_launched_t1 \
                "4b650111-cfe2-486c-9716-83234030a9e7" \
            ...
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "25a2164e-1ea2-43f4-a106-83234030a9e7"
            func_mmmv_wait_and_sync_t1
            func_mmmv_assert_folder_exists_t1 "$S_FP_C" \
                "e6a86612-5453-4ea7-b406-83234030a9e7" \
                "$SB_OPTIONAL_BAN_SYMLINKS"
            if [ "$SB_DISPLAY_NONERROR_FEEDBACK" == "t" ]; then
            ...
            #--------------------------------------------------------------
            func_mmmv_assert_folder_exists_t1 "$S_FP_C" \
                "21fe93d2-7857-43fb-8806-83234030a9e7" \
                "$SB_OPTIONAL_BAN_SYMLINKS"
            #--------------------------------------------------------------
        fi
    fi
...
func_mmmv_uncompress_tar_dot_foo_and_enter_t2(){
    ...
    if [ "$SB_COMPRESSED_FILE_WRAPS_A_SINGLE_TARFILE" != "" ]; then
        func_mmmv_assert_sbvar_domain_t_f_t1 \
            ...
            "SB_COMPRESSED_FILE_WRAPS_A_SINGLE_TARFILE" \
            "e39a2835-45ac-4354-b1f5-83234030a9e7"
    ...
    if [ "$SB_COMPRESSION_TYPE_RECOGNIZED" != "t" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='df7ee04e-6d3e-49a4-9245-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1 # exiting with an error
    ...
    func_mmmv_assert_folder_exists_t1 "$S_FP_PARENT_FOLDER" \
        "214a9818-ba94-4201-a2f5-83234030a9e7"
    cd $S_FP_PARENT_FOLDER
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "472e6693-7b13-46ca-b2f5-83234030a9e7"
    #----------------------------------------
    ...
    if [ "$SB_TAR_WRAPPED" == "t" ]; then
        ...
        if [ "$SB_COMPRESSIONLESS_TAR" == "f" ]; then
            func_mmmv_assert_file_exists_t1 "$S_FP_COMPRESSED" \
                "2e1b1437-04d1-4ea5-83f5-83234030a9e7"
            #--------
            if [ "$SB_MODE_ZIP" == "t" ]; then
                $S_CMD_NICE_PREFIX  zip --test $S_FP_COMPRESSED
                func_mmmv_assert_error_code_zero_t1 "$?" \
                    "10eee0a2-0cb5-4eff-b5e5-83234030a9e7"
            fi
            #--------
            $S_CMD_UNCOMPRESS $S_FP_COMPRESSED
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "46687181-15c6-4375-92e5-83234030a9e7"
            func_mmmv_wait_and_sync_t1
        fi
        #----------------------------------------
        func_mmmv_assert_file_exists_t1 "$S_FP_TAR" \
            "6a019422-3efc-4aa9-93e5-83234030a9e7"
        $S_CMD_NICE_PREFIX tar -xf $S_FP_TAR
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "d64bf82f-b7ed-4052-95d5-83234030a9e7"
        func_mmmv_wait_and_sync_t1
        #----------------------------------------
    else
        #----------------------------------------
        ...
        #----------------------------------------
        func_mmmv_assert_file_exists_t1 "$S_FP_COMPRESSED" \
            "a1259515-ec54-4012-8ad5-83234030a9e7"
        #--------
        if [ "$SB_MODE_ZIP" == "t" ]; then
            $S_CMD_NICE_PREFIX  zip --test $S_FP_COMPRESSED
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "443b2252-f4fa-45e4-a8d5-83234030a9e7"
        fi
        #--------
        $S_CMD_UNCOMPRESS $S_FP_COMPRESSED
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "c3e08822-b696-4ee1-9bd5-83234030a9e7"
        func_mmmv_wait_and_sync_t1
        #----------------------------------------
    fi
    #----------------------------------------
    func_mmmv_assert_folder_exists_t1 "$S_FP_NEXT_PARENT_FOLDER" \
        "4d3b039b-38b0-40e1-b9c5-83234030a9e7"
...
func_mmmv_s_owner_of_a_file_or_folder_t1(){
    ...
    if [ ! -e "$S_FP_IN" ]; then
        if [ -h "$S_FP_IN" ]; then
            func_mmmv_exc_exit_with_an_error_t2 \
                "64a92d14-25a8-41bf-a2c5-83234030a9e7" \
                "The $S_FP_IN is a broken symlink."
        else
            func_mmmv_exc_exit_with_an_error_t2 \
                "19087e32-cb47-42c0-b4c5-83234030a9e7" \
...
func_mmmv_exc_block_device_ID_to_device_file_name_t1(){ #
    ...
    if [ "$S_GUID_CANDIDATE" == "" ]; then
        ...
        echo "but it is expected to be a GUID."
        echo "Aborting script."
        echo "GUID=='46c96520-dfc1-480e-9145-83234030a9e7'"
        echo ""
        #--------
        cd "$S_FP_ORIG"
        exit 1
    ...
    if [ "$S_BLOCK_DEVICE_ID_SUBPART_CANDIDATE" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='0191d842-fa56-4ea4-b145-83234030a9e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_TMP_0" != "t" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='25cd0082-efbc-4ddb-bc35-83234030a9e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
    ...
    if [ "$S_FP_DEVICE_FILE" == "" ]; then
        ...
        echo "Aborting script."
        echo "GUID=='f42dba5e-70e3-405a-a135-83234030a9e7'"
        echo "S_GUID_CANDIDATE==\"$S_GUID_CANDIDATE\""
        echo ""
        #--------
        cd "$S_FP_ORIG"
...
func_delete_folder_of_build_folders(){
    ...
    func_mmmv_assert_folder_exists_t1 "$S_FP_FOLDER_OF_BUILD_FOLDERS" \
        "003a8b55-de46-47cc-b3b5-83234030a9e7" \
        "$SB_OPTIONAL_BAN_SYMLINKS"
    #------------------------------
    ...
    if [ -e "$S_FP_DELETABLE" ]; then
        ...
        echo ""
        echo "GUID=='1b043815-ee72-447a-9135-83234030a9e7'"
        echo ""
        #------------------------------
        cd "$S_FP_ORIG"
        exit 1
        ...
        if [ -h "$S_FP_DELETABLE" ]; then # a broken symlink here
            ...
            echo "    S_FP_DELETABLE==\"$S_FP_DELETABLE\""
            echo ""
            echo "GUID=='392e028a-8c26-47bc-a135-83234030a9e7'"
            echo ""
            #------------------------------
            cd "$S_FP_ORIG"
            exit 1
    ...
    if [ "$S_TMP_0" != "" ]; then # for safety
        ...
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "39f3b433-b189-442a-8fb5-83234030a9e7"
        func_mmmv_wait_and_sync_t1
        ...
        echo ""
        echo "GUID=='580ebea4-cfca-4c69-8435-83234030a9e7'"
        echo ""
        #------------------------------
        cd "$S_FP_ORIG"
        exit 1
...
func_first_use_message(){
    ...
    echo "GUID=='7f55a340-3217-4d58-b235-83234030a9e7'"
    echo ""
    #------------------------------
    cd "$S_FP_ORIG"
    exit 1
...
func_display_help_message(){
    ...
    echo ""
    echo -e "\e[33m    <li><a href=\"./a_file_with_an.extension\">whatever</a></li> \e[39m"
    echo ""
    echo ""
    echo -e "  COMMANDLINE_ARGUMENTS :== \e[33mINPUTDATATYPE\e[39m? \e[33mREFERENCE_TO_INPUT_DATA \e[39m? "
    echo -e "REFERENCE_TO_INPUT_DATA :== FILEPATH | URL "
    echo -e "               FILEPATH :== '/'<the rest of the filepath>'.'('html'|'htm') "
    echo -e "                    URL :== 'http'('s')?':'<the rest of the URL> "
    echo -e "          INPUTDATATYPE :== INPUTDATATYPE_FILEPATH | INPUTDATATYPE_URL "
    echo -e " INPUTDATATYPE_FILEPATH :== '\e[33m--filepath\e[39m' | '--file' | '-f' "
    echo -e "      INPUTDATATYPE_URL :== '\e[33m--URL\e[39m' | '--url' | '-u' | '-U' "
    echo -e ""
...
func_display_help_message_and_exit_if_needed(){
    ...
    if [ "$S_ARGV_1" != "" ]; then
        S_ARGV_1_SPACETABLESS="`echo \"$S_ARGV_1\" | $S_CMD_GNU_SED -e 's/[[:blank:]]\\+//g' `"
    else
        S_ARGV_1_SPACETABLESS=""
    fi
    #----------------------------------------------------------------------
...
func_determine_INPUTDATATYPE(){
    ...
    local SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA="f"
    #----------------------------------------------------------------------
    if [ "$S_ARGV_1_SPACETABLESS" != "" ]; then
        #------------------------------------------------------------------
        if [ "$S_ARGV_0_SPACETABLESS" == "-f" ]; then
            S_INPUTDATATYPE="filepath"
        else
            if [ "$S_ARGV_0_SPACETABLESS" == "--file" ]; then
                S_INPUTDATATYPE="filepath"
            else
                if [ "$S_ARGV_0_SPACETABLESS" == "--filepath" ]; then
                    S_INPUTDATATYPE="filepath"
                else
                    #------------------------------------------------------
                    if [ "$S_ARGV_0_SPACETABLESS" == "--URL" ]; then
                        S_INPUTDATATYPE="URL"
                    else
                        if [ "$S_ARGV_0_SPACETABLESS" == "--url" ]; then
                            S_INPUTDATATYPE="URL"
                        else
                            if [ "$S_ARGV_0_SPACETABLESS" == "-U" ]; then
                                S_INPUTDATATYPE="URL"
                            else
                                if [ "$S_ARGV_0_SPACETABLESS" == "-u" ]; then
                                    S_INPUTDATATYPE="URL"
                                    ...
                                    echo ""
                                    echo -e "\e[31m1. commandline argument\e[39m,"
                                    echo -e "\e[31mhas an unsupported value\e[39m of"
                                    echo ""
                                    echo "    \"$S_ARGV_0_SPACETABLESS\""
                                    echo ""
                                    echo "Supported values are, without the quotation marks: "
                                    echo "\"--file\", \"--filepath\", \"-f\", "
                                    echo "\"--URL\", \"--url\", \"-U\", \"-u\","
                                    echo "<an URL>, <a file path>."
                                    echo "GUID=='d5962d1e-8a09-4a2e-a235-83234030a9e7'"
                                    echo ""
                                    func_display_help_message
                                    #------------------------------
                                    cd "$S_FP_ORIG"
        ...
        SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA="t"
    fi
    #----------------------------------------------------------------------
    if [ "$SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA" == "t" ]; then
        #------------------------------------------------------------------
        if [ "`echo \"$S_REFERENCE_TO_INPUT_DATA\" | grep -E '^https?[:][/]' `" != "" ]; then
            S_INPUTDATATYPE="URL"
        else
            if [ "`echo \"$S_REFERENCE_TO_INPUT_DATA\" | grep -E '[.][hH][tT][mM][lL]?$' `" != "" ]; then
                S_INPUTDATATYPE="filepath"
                # Verification, whether the file exists, takes place
                # later in control flow, because this here is a guessing
                # branch, but the S_INPUTDATATYPE could be determined by
                # explicitly declaring it to be a file path by using the
                # "--file" command line argument.
            else
                #------------------------------
                echo ""
                echo -e "\e[31mFailed to detect\e[39m whether the "
                echo ""
                echo "    $S_REFERENCE_TO_INPUT_DATA "
                echo ""
                echo -e "is an URL or a file path. You may want to use the"
                echo -e "\"\e[33m--URL\e[39m\" or \"\e[33m--file\e[39m\", without the quotation marks, as"
                echo -e "the first command line argument to explicitly declare,"
                echo -e "whether it is supposed to be an URL or a file path."
                echo "Aborting script."
                echo "GUID=='217b0d25-81d5-40ab-a135-83234030a9e7'"
                echo ""
                #------------------------------
                cd "$S_FP_ORIG"
                exit 1
        ...
        if [ "$SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA" != "f" ]; then
            echo ""
            echo -e "\e[31mThis Bash script is flawed \e[39m."
            echo ""
            echo "    SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA==\"$SB_GUESS_FROM_REFERENCE_TO_INPUT_DATA\""
            echo ""
            echo "GUID=='894e2533-da84-4047-8535-83234030a9e7'"
            echo ""
            #------------------------------
            cd "$S_FP_ORIG"
            exit 1
    ...
    if [ "$S_INPUTDATATYPE" == "not_set_yet" ]; then
        echo ""
        echo -e "\e[31mThis Bash script is flawed \e[39m."
        echo "GUID=='25cea841-4d0a-4284-a535-83234030a9e7'"
        echo ""
        #------------------------------
        cd "$S_FP_ORIG"
        exit 1
...
func_add_textline_to_download_bash(){
    ...
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "22f8c585-ee05-4421-b3b5-83234030a9e7"
    func_mmmv_wait_and_sync_t1
    #----------------------------------------------------------------------
} # func_add_textline_to_download_bash
...
func_process_HTML(){
    ...
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "85cadecb-7c19-4048-82b5-83234030a9e7"
    func_mmmv_wait_and_sync_t1
    #----------------------------------------------------------------------
    $S_CMD_PREFIX_NICE cat $S_FP_HTML_CANDIDATE | \
        $S_CMD_PREFIX_NICE tr '\n\r\t' ' ' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[[:blank:]]\+/ /g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<][!][-][-].*[-][-][>]//g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[>][[:blank:]]\+[<]/></g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<][[:blank:]]\+a[[:blank:]]\+/<a /g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<][[:blank:]]*[\/][[:blank:]]*a[[:blank:]]*[>]/<\/a>/g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<][[:blank:]]*[\/][[:blank:]]*li[[:blank:]]*[>]/<\/li>/g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<][\/]li[>]/<\/li>\n/g' | \
        $S_CMD_PREFIX_NICE $S_CMD_GNU_SED -e 's/[<]li[>][<]a[[:blank:]]\+href[[:blank:]]*[=][[:blank:]]*["]/\n<li><a href="/g' | \
    ...
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "bc947c64-7917-4c62-b4b5-83234030a9e7"
    func_mmmv_wait_and_sync_t1
    #----------------------------------------------------------------------
} # func_process_HTML
...
func_mmmv_assert_error_code_zero_t1 "$?" \
    "1c249be1-0374-4ddd-b3a5-83234030a9e7"
func_mmmv_wait_and_sync_t1
#----------------------------------------------------------------------
...
echo "        echo \"GUID=='c7b61e3c-b6b7-489e-8535-83234030a9e7'\"" >> $S_FP_DOWNLOAD_BASH
...
echo "        echo \"GUID=='852a54c7-4c9e-45af-b535-83234030a9e7'\"" >> $S_FP_DOWNLOAD_BASH
echo "        echo \"S_GUID_CANDIDATE=='\$S_GUID_CANDIDATE'\"" >> $S_FP_DOWNLOAD_BASH
echo "        echo \"\"" >> $S_FP_DOWNLOAD_BASH
...
echo "        echo \"GUID=='14c8e795-67f8-44d3-a335-83234030a9e7'\"" >> $S_FP_DOWNLOAD_BASH
echo "        echo \"\"" >> $S_FP_DOWNLOAD_BASH
echo "        exit 1" >> $S_FP_DOWNLOAD_BASH
...
func_initialize_configuration_by_initializing_global_variables(){
    ...
    #----------------------------------------------------------------------
    S_REFERENCE_TO_INPUT_DATA="$S_ARGV_0_SPACETABLESS"
    if [ "$S_ARGV_1_SPACETABLESS" != "" ]; then
        S_REFERENCE_TO_INPUT_DATA="$S_ARGV_0_SPACETABLESS"
    fi
    func_determine_INPUTDATATYPE
    ...
    if [ "$S_INPUTDATATYPE" == "URL" ]; then
        ...
        if [ "$SB_MMMV_CRE_TEMPORARY_FILE_T1_EXISTS_ON_PATH" == "" ]; then
            ...
            S_TMP_0="` which mmmv_cre_temporary_file_t1 `"
            if [ "$S_TMP_0" != "" ]; then
        ...
        if [ "$SB_MMMV_CRE_TEMPORARY_FILE_T1_EXISTS_ON_PATH" == "t" ]; then
            ...
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "7372ef36-30bb-422d-82a5-83234030a9e7"
            func_mmmv_wait_and_sync_t1
            rm "$S_TMP_0"
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "444b10e4-45ae-479f-8ba5-83234030a9e7"
            func_mmmv_wait_and_sync_t1
            S_TMP_1=".html"
            ...
            S_TMP_0=".html"
            S_FP_HTML_CANDIDATE="/tmp/`whoami`_mmmv_cre_bash_URL_2_HTML_list_of_files_2_download_with_wget_t1_$S_TMP_1$S_TMP_0"
        ...
        if [ -e "$S_FP_HTML_CANDIDATE" ]; then
            ...
            echo "Thank You."
            echo "GUID=='47912375-0c87-40cf-9535-83234030a9e7'"
            echo ""
            #------------------------------
            cd "$S_FP_ORIG"
            exit 1
        ...
        #------------------------------------------------------------------
        if [ "$S_ARGV_1_SPACETABLESS" != "" ]; then
            wget "$S_ARGV_1_SPACETABLESS"  --output-document="$S_FP_HTML_CANDIDATE"
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "944677f3-238b-45e5-9195-83234030a9e7"
        else
            wget "$S_ARGV_0_SPACETABLESS"  --output-document="$S_FP_HTML_CANDIDATE"
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "92f27930-93a3-4792-b495-83234030a9e7"
        fi
        func_mmmv_wait_and_sync_t1
        #------------------------------------------------------------------
        ...
        if [ "$S_INPUTDATATYPE" != "filepath" ]; then
            ...
            echo ""
            echo -e "\e[31mThis Bash script is flawed \e[39m."
            echo "GUID=='567b8a11-d8e7-403d-a435-83234030a9e7'"
            echo ""
            #------------------------------
            cd "$S_FP_ORIG"
            exit 1
        ...
        #------------------------------------------------------------------
        if [ "$S_ARGV_1_SPACETABLESS" != "" ]; then
            func_mmmv_assert_file_exists_t1 "$S_ARGV_1_SPACETABLESS" \
                "11e13d39-0b92-4020-b295-83234030a9e7"
            S_FP_HTML_CANDIDATE="$S_ARGV_1_SPACETABLESS"
        else
            func_mmmv_assert_file_exists_t1 "$S_ARGV_0_SPACETABLESS" \
                "79e41bd1-73bd-484f-8695-83234030a9e7"
...
func_main(){
    ...
    if [ "$S_INPUTDATATYPE" == "URL" ]; then
        #------------------------------------------------------------------
        if [ "$S_ARGV_1_SPACETABLESS" != "" ]; then
            S_URLPREFIX="$S_ARGV_1_SPACETABLESS"
        else
        ...
        func_mmmv_assert_error_code_zero_t1 "$?" \
            "6cf9cf43-c1ca-4021-a485-83234030a9e7"
        #------------------------------------------------------------------
    else
        #------------------------------------------------------------------
        if [ "$S_INPUTDATATYPE" != "filepath" ]; then
            echo ""
            echo -e "\e[31mThis Bash script is flawed \e[39m."
            echo "GUID=='1455b594-094a-4d33-8135-83234030a9e7'"
            echo ""
            #------------------------------
            cd "$S_FP_ORIG"
            exit 1
        ...
        #------------------------------------------------------------------
        # The
        func_mmmv_assert_file_exists_t1 "$S_FP_HTML_CANDIDATE" \
            "8dd36442-9322-4c92-8585-83234030a9e7"
        # is a duplication, but it is here to avoid creating
        # the S_FP_DOWNLOAD_BASH in a situation, where the
        # S_FP_HTML_CANDIDATE does not exist.
        #------------------------------
        echo "    echo \"\"" >> $S_FP_DOWNLOAD_BASH
    ...
    if [ "`which upguid `" != "" ]; then
        ...
        if [ "`which ruby`" != "" ]; then
            ...
            func_mmmv_assert_error_code_zero_t1 "$?" \
                "1338d04c-d6d3-4ea7-9485-83234030a9e7"
            func_mmmv_wait_and_sync_t1
        fi
    fi
    #----------------------------------------------------------------------
    ...
    func_mmmv_assert_error_code_zero_t1 "$?" \
        "4153ace3-b054-42b2-8675-83234030a9e7"
    func_mmmv_wait_and_sync_t1
    #----------------------------------------------------------------------
    echo ""
    ...
    echo "GUID=='3f427e91-aee2-4528-8235-83234030a9e7'"
    echo ""
    #----------------------------------------------------------------------
} # func_main
func_main
...
#         <li>
#     <!-- kommentaar1
#     <li><a href="./this_should_not_be_Here.zip.rd.part_0000">Foo11</a></li>
#     -->
#     < a href="./2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0000">2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0000< /a >
#       < /li>
#         <li><a href="./2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0001">2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0001</a></li>
#         <li><a href="./2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0002">2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0002</a></li>
#         <li><a href="./2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0046">2025_07_29_wget_copy_of_computer-museum_ru_SHA256_e27c74865defcc76c162ab57daa11a51892cfed4a91a3d43ca4174e405115a92.zip.rd.part_0046</a></li>
#         <li><a href="./par2_based_error_correction_files">par2_based_error_correction_files</a></li>
#         <li><a href="./reassembly.bash">reassembly.bash</a></li>
#     </ul>
#     </body>
#     </html>
#--------------------------------------------------------------------------
...
exit 0
#==========================================================================
# S_VERSION_OF_THIS_FILE="50a3e327-f9d9-4748-a475-83234030a9e7"
#==========================================================================
