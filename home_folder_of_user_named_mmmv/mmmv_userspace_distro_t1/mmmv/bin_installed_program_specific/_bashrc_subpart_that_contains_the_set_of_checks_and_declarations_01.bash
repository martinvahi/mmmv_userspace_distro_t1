...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='5208735f-515b-45ea-a486-63b2a0717ae7'"
    echo ""
...
if [ "$SB_PAR_TEXT_FORMATTER_EXISTS_ON_PATH" == "" ]; then
    ...
    if [ "`which par_text_formatter 2> /dev/null`" != "" ]; then
        ...
        func_mmmv_userspace_distro_t1_err_msg_console_program_missing_t1 \
            "par_text_formatter" "d43e671b-041e-4af3-8186-63b2a0717ae7"
    fi
fi
#--------------------------------------------------------------------------
...
if [ "$SB_QUTEBROWSER_EXISTS_ON_PATH" == "t" ]; then
    ...
    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
        "$S_TMP_0" \
        "84e80171-f732-4766-9586-63b2a0717ae7" \
...
#--------------------------------------------------------------------------
S_TMP_0="$MMMV_USERSPACE_DISTRO_T1_BIN_INSTALLED_PROGRAM_SPECIFIC/scripts_by_dependency_sets/grep_gsed_qemuimg_replace_rev_tar_tr_wc"
if [ "$SB_QEMUIMG_EXISTS_ON_PATH" == "t" ]; then
...
#--------------------------------------------------------------------------
S_TMP_0="$MMMV_USERSPACE_DISTRO_T1_BIN_INSTALLED_PROGRAM_SPECIFIC/scripts_by_dependency_sets/fclist_grep_gsed_pandoc_printf_tr_xelatex"
if [ "$SB_XELATEX_EXISTS_ON_PATH" == "t" ]; then
...
#==========================================================================
# S_VERSION_OF_THIS_FILE="5c377e1a-6d29-4468-b486-63b2a0717ae7"
#==========================================================================
