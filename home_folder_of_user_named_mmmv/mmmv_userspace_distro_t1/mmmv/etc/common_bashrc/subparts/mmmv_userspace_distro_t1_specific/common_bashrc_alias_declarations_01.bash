...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='539fd1f3-c8d8-4188-a17d-a29090717ae7'"
    echo ""
...
if [ "$SB_OPERATINGSYSTEM_LINUX" == "f" ]; then
    if [ "$SB_OPERATINGSYSTEM_LINUX_WSL" == "t" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            ...
            echo "GUID=='def59e37-9f46-4fc0-a27d-a29090717ae7'"
            echo ""
        fi
    fi
    if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID" == "t" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash file is flawed.\e[39m"
            echo "GUID=='73417812-d5bd-41a9-b27d-a29090717ae7'"
            echo ""
        fi
    fi
    if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID_TERMUX" == "t" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash file is flawed.\e[39m"
            echo "GUID=='4c50d858-ebf5-47a4-937d-a29090717ae7'"
            echo ""
        fi
    fi
fi
...
if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID" == "f" ]; then
    if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID_TERMUX" == "t" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash file is flawed.\e[39m"
            echo "GUID=='feac9946-8a03-4146-a37d-a29090717ae7'"
            echo ""
        fi
    fi
fi
...
if [ "$SB_OPERATINGSYSTEM_BSD_FREEBSD" == "t" ]; then
    if [ "$SB_OPERATINGSYSTEM_BSD" == "f" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash file is flawed.\e[39m"
            echo "GUID=='03c50523-8ea6-45ba-957d-a29090717ae7'"
            echo ""
        fi
    fi
fi
...
if [ "$SB_OPERATINGSYSTEM_LINUX" == "t" ]; then
    ...
    if [ "$SB_OPERATINGSYSTEM_LINUX_WSL" == "t" ]; then
        ...
        if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID" == "f" ]; then
            ...
            alias mmmv_admin_create_symlink_to_cupspdf_t1="S_FP_LINK=\"\$HOME/CUPS_PDF\" ; S_FP_CUPSPDF_OUTPUT_DIR_0=\"/var/spool/cups-pdf/ANONYMOUS\" ; S_FP_CUPSPDF_OUTPUT_DIR_X=\"\$S_FP_CUPSPDF_OUTPUT_DIR_0\" ; S_FP_CUPSPDF_OUTPUT_DIR_1=\"/var/spool/cups-pdf/\`whoami\`\" ; if [ -e \"\$S_FP_CUPSPDF_OUTPUT_DIR_1\" ]; then S_FP_CUPSPDF_OUTPUT_DIR_X=\"\$S_FP_CUPSPDF_OUTPUT_DIR_1\" ; fi ; if [ -e \"\$S_FP_CUPSPDF_OUTPUT_DIR_X\" ]; then if [ -d \"\$S_FP_CUPSPDF_OUTPUT_DIR_X\" ]; then if [ -e \"\$S_FP_LINK\" ]; then echo \"\" ; echo \"Something with the path of \" ; echo \"    \$S_FP_LINK\" ; echo -e \"\e[31malready exists.\e[39m Doing nothing.\" ; echo \"GUID=='32bdaa6b-a96a-4dca-946d-a29090717ae7'\" ; echo \"\" ; else if [ -h \"\$S_FP_LINK\" ]; then echo \"\" ; echo \"A broken symlink with the path of \" ; echo \"    \$S_FP_LINK\" ; echo -e \"\e[31malready exists.\e[39m Doing nothing.\" ; echo \"GUID=='2dc1c93e-01c4-4fb3-a56d-a29090717ae7'\" ; echo \"\" ; else ln -s \"\$S_FP_CUPSPDF_OUTPUT_DIR_X\" \"\$S_FP_LINK\" ; sync; wait; sync ;  if [ ! -e \"\$S_FP_LINK\" ]; then echo \"\" ; echo -e \"\e[31mFailed to create symlink \e[39m\" ; echo \"    \$S_FP_LINK\" ; echo \"    -->\" ; echo \"    \$S_FP_CUPSPDF_OUTPUT_DIR_X\" ; echo \"GUID=='e89ee511-876c-45ee-a56d-a29090717ae7'\" ; echo \"\" ; fi ; fi ; fi ; else echo \"\" ; echo \"The \" ; echo \"    \$S_FP_CUPSPDF_OUTPUT_DIR_X\" ; if [ -h \"\$S_FP_CUPSPDF_OUTPUT_DIR_X\" ]; then echo \"is a symlink to a file, but a folder is expected.\" ; else echo \"is a file, but a folder is expected.\" ; fi ; echo \"GUID=='ca8d4f1f-6bf6-40e4-916d-a29090717ae7'\" ; echo \"\" ; fi ; else echo \"\" ; echo -e \"\e[31mFolder is missing. \e[39m\" ; echo \"    \$S_FP_CUPSPDF_OUTPUT_DIR_X\" ; echo \"It MIGHT be that the cups-pdf has not been installed.\" ; echo \"GUID=='4697d01c-14f1-4423-b46d-a29090717ae7'\" ; echo \"\" ; fi ;"
            # except the GUIDs, is:
            ...
            #                 echo "GUID=='cb4e1310-a453-48e7-856d-a29090717ae7'" ;
            #                 echo "" ;
            #             else
            #                 if [ -h "$S_FP_LINK" ]; then
            #                     echo "" ;
            ...
            #                     echo "    $S_FP_LINK" ;
            #                     echo -e "\e[31malready exists.\e[39m Doing nothing." ;
            #                     echo "GUID=='7fd3745a-80bd-4feb-926d-a29090717ae7'" ;
            #                     echo "" ;
            #                 else
            ...
            #                         echo "GUID=='417c3c3e-8ab8-4aa9-956d-a29090717ae7'" ;
            #                         echo "" ;
            #                     fi ;
            #                 fi ;
            #             fi ;
            ...
            #             fi ;
            #             echo "GUID=='7d90b613-755c-4888-925d-a29090717ae7'" ;
            #             echo "" ;
            #         fi ;
            #     else
            #         echo "" ;
            ...
            #         echo "GUID=='1b693e38-c81f-4403-b15d-a29090717ae7'" ;
            #         echo "" ;
            #     fi ;
        fi
    fi
    ...
    if [ "$SB_OPERATINGSYSTEM_BSD" == "t" ]; then
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            echo ""
            echo -e "\e[31mThe code of this Bash file is flawed.\e[39m"
            echo "GUID=='86508f4d-2bde-40b3-a55d-a29090717ae7'"
            echo ""
        fi
    fi
    #----------------------------------------------------------------------
...
func_mmmv_declare_template_creation_alias_t1(){
    ...
    if [ "$S_FP_DESTINATION_FOLDER_OPTIONAL" == "" ]; then
        ...
        if [ "$SB_OK2ATTEMPT" == "t" ]; then
            ...
            func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                ...
                "95cdee3a-1c40-412b-b26d-a29090717ae7" \
    ...
    if [ "$SB_OK2ATTEMPT" == "t" ]; then
        ...
        if [ "$S_GUID_CANDIDATE_OPTIONAL" == "" ]; then
            S_GUID_CANDIDATE_OPTIONAL="8bde3856-8576-4668-936d-a29090717ae7"
        else
            ...
            if [ "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL" != "t" ]; then
                if [ "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL" != "f" ]; then
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "GUID=='5b345c5e-364d-46ba-925d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
        ...
        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
            ...
            #                    echo \"    $S_FP_NEW \"; \
            #                    echo \"\"; \
            #                    echo \"GUID=='0e46df10-056a-41be-b25d-a29090717ae7'\"; \
            ...
            #                echo \"GUID=='1e245992-3150-4386-a55d-a29090717ae7'\"; \
            #                if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
            #                    echo \"$S_ERR_MSG_SUBPART_01\"; \
            #                fi;\
            #                echo \"\"; \
            ...
            #            echo \"GUID=='32ef033d-6750-4eaf-835d-a29090717ae7'\"; \
            #            if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
            #                echo \"$S_ERR_MSG_SUBPART_01\"; \
            #            fi;\
            #            echo \"\"; \
            ...
            #        echo -e \"\\e[31mbut a file is expected.\\e[39m\"; \
            #        echo \"Not copying anything.\"; \
            #        echo \"GUID=='5151e93e-c8d3-4b72-b45d-a29090717ae7'\"; \
            #        if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
            #            echo \"$S_ERR_MSG_SUBPART_01\"; \
            #        fi;\
            #        echo \"\"; \
...
func_mmmv_declare_template_creation_alias_tar_gz_t1(){
    ...
    local S_ERR_MSG_SUBPART_01=""
    if [ "$S_GUID_CANDIDATE_OPTIONAL" == "" ]; then
        S_GUID_CANDIDATE_OPTIONAL="842a0b2b-7367-42e5-a16d-a29090717ae7"
    else
        #S_ERR_MSG_SUBPART_01="echo \"S_GUID_CANDIDATE=='$S_GUID_CANDIDATE_OPTIONAL'\" ; "
        S_ERR_MSG_SUBPART_01="S_GUID_CANDIDATE=='$S_GUID_CANDIDATE_OPTIONAL'"
    fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        ...
        #                    echo \"    $S_FP_NEW \"; \
        #                    echo \"\"; \
        #                    echo \"GUID=='5b7d7e35-11da-4770-924d-a29090717ae7'\"; \
        #                    if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                        echo \"$S_ERR_MSG_SUBPART_01\"; \
        #                    fi;\
        #                    echo \"\"; \
        ...
        #                echo \"\"; \
        #                echo -e \"\\e[31malready exists\\e[39m. Not overwriting.\"; \
        #                echo \"GUID=='014c2e3a-b482-4747-824d-a29090717ae7'\"; \
        #                if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                    echo \"$S_ERR_MSG_SUBPART_01\"; \
        #                fi;\
        #                echo \"\"; \
        ...
        #            echo -e \"\\e[31mbut a file is expected.\\e[39m\"; \
        #            echo \"Not copying anything.\"; \
        #            echo \"GUID=='579ce892-025a-494c-a74d-a29090717ae7'\"; \
        #            if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                echo \"$S_ERR_MSG_SUBPART_01\"; \
        #            fi;\
        #            echo \"\"; \
        ...
        #        echo -e \"\\e[31mbut a file is expected.\\e[39m\"; \
        #        echo \"Not copying anything.\"; \
        #        echo \"GUID=='9730d635-0417-48ae-853d-a29090717ae7'\"; \
        #        if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #            echo \"$S_ERR_MSG_SUBPART_01\"; \
        #        fi;\
        #        echo \"\"; \
        ...
        # #------------------------------
        # is meant to be processed with Vim macros for assembling the
        alias $S_ALIAS_NAME="if [ -e \"$S_FP_TEMPLATE\" ]; then if [ ! -d \"$S_FP_TEMPLATE\" ]; then if [ ! -e \"$S_FP_NEW\" ]; then $S_FP_NICE -n 10 tar -xzf $S_FP_TEMPLATE ./ ; if [ \"\$?\" == \"0\" ]; then sync; wait; echo \"\"; if [ -d \"$S_FP_NEW\" ]; then if [ -h \"$S_FP_NEW\" ]; then echo \"Created a new symlink to a folder with the path of \"; else echo \"Created a new folder with the path of \"; fi; else if [ -h \"$S_FP_NEW\" ]; then echo \"Created a new symlink to a file with the path of \"; else echo \"Created a new file with the path of \"; fi; fi; echo \"\"; echo \"    $S_FP_NEW \"; echo \"\"; else echo -e \"\\e[31mFailed to create \\e[39m \"; echo \"\"; echo \"    $S_FP_NEW \"; echo \"\"; echo \"GUID=='7b3af42f-5b24-4c20-833d-a29090717ae7'\"; if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo \"\"; if [ -d \"$S_FP_NEW\" ]; then echo \"A folder with the path of \"; else echo \"A file with the path of \"; fi; echo \"\"; echo \"    $S_FP_NEW\"; echo \"\"; echo -e \"\\e[31malready exists\\e[39m. Not overwriting.\"; echo \"GUID=='d91ab731-c108-42a5-843d-a29090717ae7'\"; if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo \"\"; echo \"The template \"; echo \"\"; echo \"    $S_FP_TEMPLATE\"; echo \"\"; if [ -h \"$S_FP_TEMPLATE\" ]; then echo -e \"\\e[31mis a symlink to a folder,\\e[39m\"; else echo -e \"\\e[31mis a folder,\\e[39m\"; fi; echo -e \"\\e[31mbut a file is expected.\\e[39m\"; echo \"Not copying anything.\"; echo \"GUID=='6ade5120-b101-4024-933d-a29090717ae7'\"; if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo \"\"; echo \"The template \"; echo \"\"; echo \"    $S_FP_TEMPLATE\"; echo \"\"; if [ -h \"$S_FP_TEMPLATE\" ]; then echo -e \"\\e[31mis a broken symlink,\\e[39m\"; else echo -e \"\\e[31mis missing,\\e[39m\"; fi; echo -e \"\\e[31mbut a file is expected.\\e[39m\"; echo \"Not copying anything.\"; echo \"GUID=='6f2d8506-ce06-4afa-923d-a29090717ae7'\"; if [ \"$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; "
        #--------------------
    fi
    #----------------------------------------------------------------------
} # func_mmmv_declare_template_creation_alias_tar_gz_t1
...
func_mmmv_declare_template_creation_alias_zip_t1(){
    ...
    local S_ERR_MSG_SUBPART_01=""
    if [ "$S_GUID_CANDIDATE_OPTIONAL" == "" ]; then
        S_GUID_CANDIDATE_OPTIONAL="d2840324-415a-4d58-816d-a29090717ae7"
    else
        #S_ERR_MSG_SUBPART_01="echo \"S_GUID_CANDIDATE=='$S_GUID_CANDIDATE_OPTIONAL'\" ; "
        S_ERR_MSG_SUBPART_01="S_GUID_CANDIDATE=='$S_GUID_CANDIDATE_OPTIONAL'"
    fi
    ...
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        ...
        #                         echo \"    \$S_FP_NEW \"; \
        #                         echo \"\"; \
        #                         echo \"GUID=='d671d44c-785e-46cb-b23d-a29090717ae7'\"; \
        #                         if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                             echo \"\$S_ERR_MSG_SUBPART_01\"; \
        #                         fi;\
        #                         echo \"\"; \
        ...
        #                     echo \"\"; \
        #                     echo -e \"\\e[31malready exists\\e[39m. Not overwriting.\"; \
        #                     echo \"GUID=='9ee14432-4f26-481a-a23d-a29090717ae7'\"; \
        #                     if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                         echo \"\$S_ERR_MSG_SUBPART_01\"; \
        #                     fi;\
        #                     echo \"\"; \
        ...
        #                 echo \"GUID=='f5389432-e613-4543-b43d-a29090717ae7'\"; \
        #             fi\
        #         else \
        #             echo \"\"; \
        #             echo \"The template \"; \
        ...
        #             echo -e \"\\e[31mbut a file is expected.\\e[39m\"; \
        #             echo \"Not copying anything.\"; \
        #             echo \"GUID=='14259a72-b2ea-483c-af3d-a29090717ae7'\"; \
        #             if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #                 echo \"\$S_ERR_MSG_SUBPART_01\"; \
        #             fi;\
        #             echo \"\"; \
        ...
        #         echo -e \"\\e[31mbut a file is expected.\\e[39m\"; \
        #         echo \"Not copying anything.\"; \
        #         echo \"GUID=='018f1d97-36b5-4672-b33d-a29090717ae7'\"; \
        #         if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then \
        #             echo \"\$S_ERR_MSG_SUBPART_01\"; \
        #         fi;\
        #         echo \"\"; \
        ...
        # #------------------------------
        # is meant to be processed with Vim macros for assembling the
        alias $S_ALIAS_NAME="if [ -e \"$S_FP_TEMPLATE\" ]; then if [ ! -d \"$S_FP_TEMPLATE\" ]; then $S_FP_NICE -n 10 zip --test \"$S_FP_TEMPLATE\" ; if [ \"\$?\" == \"0\" ]; then if [ ! -e \"$S_FP_NEW\" ]; then $S_FP_NICE -n 10 unzip $S_FP_TEMPLATE ; if [ \"\$?\" == \"0\" ]; then sync; wait; echo \"\"; if [ -d \"$S_FP_NEW\" ]; then if [ -h \"$S_FP_NEW\" ]; then echo \"Created a new symlink to a folder with the path of \"; else echo \"Created a new folder with the path of \"; fi; else if [ -h \"$S_FP_NEW\" ]; then echo \"Created a new symlink to a file with the path of \"; else echo \"Created a new file with the path of \"; fi; fi; echo \"\"; echo \"    $S_FP_NEW \"; echo \"\"; else echo -e \"\\e[31mFailed to create \\e[39m \"; echo \"\"; echo \"    $S_FP_NEW \"; echo \"\"; echo \"GUID=='569acb3f-bb8b-4b18-852d-a29090717ae7'\"; if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"\$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo \"\"; if [ -d \"$S_FP_NEW\" ]; then echo \"A folder with the path of \"; else echo \"A file with the path of \"; fi; echo \"\"; echo \"    $S_FP_NEW\"; echo \"\"; echo -e \"\\e[31malready exists\\e[39m. Not overwriting.\"; echo \"GUID=='842cc856-b046-4b4c-832d-a29090717ae7'\"; if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"\$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo -e \"The zip file \"; echo \"\"; echo \"    $S_FP_TEMPLATE \"; echo \"\"; echo -e \"\\e[31mis corrupted\\e[39m or it is not a zip file.\"; echo \"GUID=='8e45ef45-413a-4a77-b32d-a29090717ae7'\"; fi else echo \"\"; echo \"The template \"; echo \"\"; echo \"    $S_FP_TEMPLATE\"; echo \"\"; if [ -h \"$S_FP_TEMPLATE\" ]; then echo -e \"\\e[31mis a symlink to a folder,\\e[39m\"; else echo -e \"\\e[31mis a folder,\\e[39m\"; fi; echo -e \"\\e[31mbut a file is expected.\\e[39m\"; echo \"Not copying anything.\"; echo \"GUID=='1793ae85-0801-4b66-932d-a29090717ae7'\"; if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"\$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; else echo \"\"; echo \"The template \"; echo \"\"; echo \"    $S_FP_TEMPLATE\"; echo \"\"; if [ -h \"$S_FP_TEMPLATE\" ]; then echo -e \"\\e[31mis a broken symlink,\\e[39m\"; else echo -e \"\\e[31mis missing,\\e[39m\"; fi; echo -e \"\\e[31mbut a file is expected.\\e[39m\"; echo \"Not copying anything.\"; echo \"GUID=='dc3c5b2a-1abe-46a7-a42d-a29090717ae7'\"; if [ \"\$S_ERR_MSG_SUBPART_01\" != \"\" ]; then echo \"\$S_ERR_MSG_SUBPART_01\"; fi; echo \"\"; fi; "
        #--------------------
    fi
    #----------------------------------------------------------------------
} # func_mmmv_declare_template_creation_alias_zip_t1
...
func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
    "$S_TMP_FP_0" "e5a25e2f-2ff6-44eb-b26d-a29090717ae7" \
    "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        ...
        if [ "$SB_RSYNC_EXISTS_ON_PATH" == "t" ]; then
            ...
            if [ "$SB_RSYNC_EXISTS_ON_PATH" != "f" ]; then
                if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                    ...
                    echo "GUID=='581fcb12-4638-40fd-812d-a29090717ae7'"
                fi
            fi
            alias mmmv_cre_rsync_based_backups_creator="echo \"\" ; echo \"The \\\"rsync\\\" is not on PATH.\" ; echo \"GUID=='7f0ee63c-b1b6-46af-a42d-a29090717ae7'\" ; echo \"\" ; $S_TMP_0"
        fi
  fi
fi
#--------------------------------------------------------------------------
...
if [ "$SB_TAR_EXISTS_ON_PATH" == "t" ]; then
    if [ "$SB_GUNZIP_EXISTS_ON_PATH" == "t" ]; then
        ...
        func_mmmv_declare_template_creation_alias_tar_gz_t1 \
            ...
            "35a03946-81be-459f-b54d-a29090717ae7"
        #----
        ...
        func_mmmv_declare_template_creation_alias_tar_gz_t1 \
            ...
            "07c20247-395d-4732-b33d-a29090717ae7"
        #----
        # The .tar.gz at the following alias declaration function call
        func_mmmv_declare_template_creation_alias_tar_gz_t1 \
            ...
            "4de5f334-c7cd-46bc-933d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "COMMENTS.txt" \
    "f01c79b5-1cf0-48cb-913d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "COMMENTS.txt" \
    "4548a71f-476e-4aca-823d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "28ed0121-326a-4b96-b32d-a29090717ae7"

func_mmmv_declare_template_creation_alias_t1 \
    "mmmv_cre_bash_download_t1" \
    "2023_12_20_download_template_t1.bash" \
    "download.bash" \
    "44d45671-5225-4e5b-932d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "3a787915-cbee-48aa-922d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "Ruby_v_3_4_1_backwards_compatibility_with_v_2_4_0_t1.rb" \
    "31136352-f3d0-49b6-892d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "f2abc833-8d33-410e-b22d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "9eefea3a-7726-48cc-b21d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "9510bf13-4a7e-4bac-b41d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "a5b5d950-5d09-46b1-a11d-a29090717ae7"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "config.toml" \
    "7ca6bf47-8fb0-4520-931d-a29090717ae7" \
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "1ccecd5e-d44e-4edb-b41d-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "13dfd004-da32-4ece-93fc-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "2dc28414-4cc9-4a30-85ec-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "588ee744-cc45-4fe0-92ec-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "ruby_console_application.rb" \
    "32dfb3a1-976e-49ae-b2dc-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "reassembly.bash" \
    "32715aa4-b203-4e8f-bfdc-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
...
func_mmmv_declare_template_creation_alias_t1 \
    ...
    "a1813f86-62d1-40a6-b5dc-a29090717ae7" \
    "$SB_USE_UPGUID_ON_COPIED_FILE_OPTIONAL"
#--------------------------------------------------------------------------
...
func_mmmv_userspace_distro_t1_display_man_page_with_emacs_t1(){
    ...
    if [ "$SB_EMACS_EXISTS_ON_PATH" == "t" ]; then
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            ...
            echo "GUID=='5a54dec4-a1ac-485a-832d-a29090717ae7'"
            echo ""
        fi
    fi
} # func_mmmv_userspace_distro_t1_display_man_page_with_emacs_t1
...
func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
    "$S_FP_1a" "3495ad26-2e40-457e-81bc-a29090717ae7" \
    "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
        "$S_FP_2a" "7595a739-47e0-45bf-b1bc-a29090717ae7" \
        "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
...
if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID_TERMUX" == "t" ]; then
    ...
    func_mmmv_userspace_distro_t1_declare_alias_cd_t1 \
        ...
        "3d919d24-dbe4-437e-85ac-a29090717ae7" \
        "$SB_OPTIONAL_DISPLAY_ERROR_MESSAGE_IF_FOLDER_MISSING"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
        S_TMP_0="/sdcard/Download"
        func_mmmv_userspace_distro_t1_declare_alias_cd_t1 \
            "mmmv_go_Download" "$S_TMP_0" \
            "589a9921-d2d7-4f37-91ac-a29090717ae7" \
            "$SB_OPTIONAL_DISPLAY_ERROR_MESSAGE_IF_FOLDER_MISSING"
        S_TMP_0="/sdcard/download"
        func_mmmv_userspace_distro_t1_declare_alias_cd_t1 \
            "mmmv_go_download" "$S_TMP_0" \
            "f7803c59-6faa-4327-a1ac-a29090717ae7" \
            "$SB_OPTIONAL_DISPLAY_ERROR_MESSAGE_IF_FOLDER_MISSING"
    fi
    #--------------------
fi
...
if [ ! -e "$FP_MMMV" ]; then
    ...
    func_mmmv_wait_and_sync_t1
    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
        "$FP_MMMV" "574c99f2-522f-4aea-b29c-a29090717ae7" \
        "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
fi
#--------------------------------------------------------------------------
if [ ! -e "$FP_MMMV_BASHRC" ]; then
    ...
    func_mmmv_wait_and_sync_t1
    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
        "$FP_MMMV_BASHRC" "5622b1d4-63b2-4d1b-a59c-a29090717ae7" \
        "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
fi
#--------------------------------------------------------------------------
if [ -e "$FP_MMMV" ]; then
    if [ -d "$FP_MMMV" ]; then
        ...
        func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
            "$FP_MMMV_USERSPECIFIC_SUBPART_OF_VIMRC" \
            "4369eb36-92c4-4cfb-b38c-a29090717ae7" \
            "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
        #------------------------------------------------------------------
        if [ -e "$FP_MMMV_BASHRC" ]; then
            if [ -d "$FP_MMMV_BASHRC" ]; then
                ...
                func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                    ...
                    "5d5c2458-6e21-47da-a48c-a29090717ae7" \
                    "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
                if [ -e "$FP_MMMV_BASHRC_DYNAMIC_SYMLINKS_ON_PATH" ]; then
            ...
            if [ "$SB_FALKON_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_FALKON" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "GUID=='d71d174b-dd6b-43ad-842d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_CHROMIUM_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_CHROMIUM" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='e14b8b1a-d2be-4361-942d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_QUTEBROWSER_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_QUTEBROWSER" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='1de6fc25-ae30-41ab-b51d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_REKONQ_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_REKONQ" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='3210c041-e9b4-4e1a-831d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_NETSURF_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_NETSURF" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='176aa0f1-c167-458b-bf1d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_DILLO_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_DILLO" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='caba1e38-e1d0-4dc5-951d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
            ...
            if [ "$SB_DILLOPLUS_EXISTS_ON_PATH" == "t" ]; then
                if [ "$S_FP_DILLOPLUS" != "" ]; then # just in case
                    ...
                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                        ...
                        echo "have the value of an empty string."
                        echo "GUID=='2b08f721-5681-456c-851d-a29090717ae7'"
                        echo ""
                    fi
                fi
            fi
...
if [ -e "$S_FP_0" ]; then
    if [ ! -d "$S_FP_0" ]; then
        if [ "$SB_SED_OR_GSED_EXISTS_ON_PATH" == "t" ]; then
            ...
            #--------------------------------------------------------------
            func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
                "$S_FP_0" "78de1e11-1ce2-4714-b58c-a29090717ae7" \
                "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
            #--------------------------------------------------------------
        fi
    fi
...
if [ -e "$S_FP_0" ]; then
    if [ ! -d "$S_FP_0" ]; then
        ...
        #------------------------------------------------------------------
        func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
            "$S_FP_0" "d9b7d324-f686-408a-917c-a29090717ae7" \
            "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
        #------------------------------------------------------------------
    fi
fi
                    ...
                    if [ "$SB_FLATPAK_EXISTS_ON_PATH" == "t" ]; then
                        if [ "$S_CMD_FLATPAK_USER" != "" ]; then
                                ...
                                if [ "$SB_GSED_EXISTS_ON_PATH" == "t" ]; then
                                    ...
                                    if [ "$S_FP_FLATPAK_JAILBREAK_FOLDER" != "" ]; then
                                        ...
                                        func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                                            ...
                                            "9d9b2d36-c094-45e1-927c-a29090717ae7" \
                                            "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
                                        if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
                                        ...
                                        if [ -e "$S_FP_2" ]; then
                                            func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
                                                "$S_FP_2" \
                                                "6e6f6743-ec2d-43ea-926c-a29090717ae7" \
                                                "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
                                            if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
                                                S_FP_1="$S_FP_2"
                                            fi
                                    ...
                                    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                                        ...
                                        echo "GUID=='5d09e8ff-1b28-4a84-91dc-a29090717ae7'"
                                        echo ""
                                    fi
                                    #--------------------------------------
                                fi
                            ...
                            if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
                                ...
                                echo "GUID=='d45a5a27-bf35-4d5b-a5dc-a29090717ae7'"
                                echo ""
                            fi
                            #----------------------------------------------
                        fi
...
#                         echo -e "GUID=='f7a0c143-5301-41ea-a1cc-a29090717ae7'" ;
#                     else
#                         printf "Copying .. " ;
#                         wait ; sync ; wait ;
...
#                     echo -e "GUID=='30e583c5-a7cb-4f14-85cc-a29090717ae7'" ;
#                 fi ;
#             else
#                 if [ -h $S_FP_0 ]; then
#                     echo -e "The origin " ;
...
#                 fi ;
#                 echo -e "a file is expected." ;
#                 echo -e "GUID=='f32f3244-72ef-4ed5-91bc-a29090717ae7'" ;
#             fi ;
#         else
#             if [ -h $S_FP_0 ]; then
#                 echo -e "The origin " ;
...
#                 echo -e "" ;
#                 echo -e "\e[31mis a broken symlink\e[39m." ;
#                 echo -e "GUID=='01d08557-9e2f-4967-b3bc-a29090717ae7'" ;
#             else
#                 echo -e "The origin " ;
#                 echo -e "" ;
#                 echo -e "    $S_FP_0" ;
...
#                 echo -e "GUID=='f713f052-8011-411b-82bc-a29090717ae7'" ;
#             fi ;
#         fi ;
#     else
...
#         echo -e "GUID=='1a3753f7-6553-4475-94bc-a29090717ae7'" ;
#     fi ;
# else
#     if [ -h $S_FP_DESTINATION_FOLDER ]; then
#         echo -e "The destination " ;
...
#         echo -e "" ;
#         echo -e "\e[31mis a broken symlink\e[39m." ;
#         echo -e "GUID=='439df9c2-5a2d-44bf-9bac-a29090717ae7'" ;
#     else
#         echo -e "The destination " ;
#         echo -e "" ;
#         echo -e "    $S_FP_DESTINATION_FOLDER" ;
#         echo -e "" ;
#         echo -e "\e[31mdoes not exist\e[39m." ;
#         echo -e "GUID=='5c8ca445-05a9-4287-baac-a29090717ae7'" ;
#     fi ;
# fi ;
#
if [ "$SB_RUBY_EXISTS_ON_PATH" == "t" ]; then
    if [ "$SB_PRINTF_EXISTS_ON_PATH" == "t" ]; then
        ...
        alias mmmv_cp_2_S_0="mmmv_polish_ABC_2_ACB_exec_t1  \"S_FP_0=\\\"\"   \"\\\" ; S_FP_DESTINATION_FOLDER=\\\"\$S_0\\\" ; if [ -e \\\$S_FP_DESTINATION_FOLDER ]; then if [ -d \\\$S_FP_DESTINATION_FOLDER ]; then if [ -e \\\$S_FP_0 ]; then if [ ! -d \\\$S_FP_0 ]; then if [ ! -h \\\$S_FP_0 ]; then nice -n 4 cp \\\"\\\$S_FP_0\\\"  \\\"\\\$S_FP_DESTINATION_FOLDER/\\\" ; if [ \\\"\\\$?\\\" != \\\"0\\\" ]; then echo -e \\\"\\\\e[31mCopying failed\\\\e[39m.\\\" ; echo -e \\\"GUID=='5d24883b-77c1-40b6-939c-a29090717ae7'\\\" ; else printf \\\"Copying .. \\\" ; wait ; sync ; wait ; echo -e \\\"\\\\e[32msucceeded\\\\e[39m.\\\" ; fi ; else echo -e \\\"The origin \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_0\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a symlink to a file\\\\e[39m, but\\\" ; echo -e \\\"a file is expected.\\\" ; echo -e \\\"GUID=='30ab1094-31f2-4a9d-849c-a29090717ae7'\\\" ; fi ; else if [ -h \\\$S_FP_0 ]; then echo -e \\\"The origin \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_0\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a symlink to a folder\\\\e[39m, but\\\" ; else echo -e \\\"The origin \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_0\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a folder\\\\e[39m, but\\\" ; fi ; echo -e \\\"a file is expected.\\\" ; echo -e \\\"GUID=='364debf6-d23d-463a-939c-a29090717ae7'\\\" ; fi ; else if [ -h \\\$S_FP_0 ]; then echo -e \\\"The origin \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_0\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a broken symlink\\\\e[39m.\\\" ; echo -e \\\"GUID=='430ddf4f-a81f-46fb-838c-a29090717ae7'\\\" ; else echo -e \\\"The origin \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_0\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mdoes not exist\\\\e[39m.\\\" ; echo -e \\\"GUID=='1e25ed2f-2a37-4a25-818c-a29090717ae7'\\\" ; fi ; fi ; else if [ -h \\\$S_FP_DESTINATION_FOLDER ]; then echo -e \\\"The destination \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_DESTINATION_FOLDER\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a symlink to a file\\\\e[39m, but\\\" ; else echo -e \\\"The destination \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_DESTINATION_FOLDER\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a file\\\\e[39m, but\\\" ; fi ; echo -e \\\"a folder or a symlink to a folder is expected.\\\" ; echo -e \\\"GUID=='b4ab19f8-e999-4ec3-8d7c-a29090717ae7'\\\" ; fi ; else if [ -h \\\$S_FP_DESTINATION_FOLDER ]; then echo -e \\\"The destination \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_DESTINATION_FOLDER\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mis a broken symlink\\\\e[39m.\\\" ; echo -e \\\"GUID=='1cb22d46-5c5d-49c5-827c-a29090717ae7'\\\" ; else echo -e \\\"The destination \\\" ; echo -e \\\"\\\" ; echo -e \\\"    \\\$S_FP_DESTINATION_FOLDER\\\" ; echo -e \\\"\\\" ; echo -e \\\"\\\\e[31mdoes not exist\\\\e[39m.\\\" ; echo -e \\\"GUID=='3eaff7d5-033d-4764-927c-a29090717ae7'\\\" ; fi ; fi ; \" "
    fi
fi
#--------------------------------------------------------------------------
if [ "$SB_OPERATINGSYSTEM_LINUX" == "t" ]; then
...
# #     echo "GUID=='553b9c22-04d7-4f28-b46c-a29090717ae7'" ;
# #     echo "" ;
# # else
# #     echo "" > ./Makefile ;
...
if [ "$SB_MAKEDEPEND_EXISTS_ON_PATH" == "t" ]; then
    if [ "$SB_GREP_EXISTS_ON_PATH" == "t" ]; then
        if [ "$SB_SED_EXISTS_ON_PATH" == "t" ]; then
            if [ "$SB_CAT_EXISTS_ON_PATH" == "t" ]; then
                alias mmmv_run_makedepend_dot_t1=" S_FP_MAKEFILE=\"\`pwd\`/Makefile\" ; if [ -e \"\$S_FP_MAKEFILE\" ]; then echo \"\" ; echo -e \"\\e[31mMakefile already exists\\e[39m at path \" ; echo \"\" ; echo \"    \$S_FP_MAKEFILE\" ; echo \"\" ; echo \"Not doing anything.\" ; echo \"GUID=='77814a28-871b-4ea9-a46c-a29090717ae7'\" ; echo \"\" ; else echo \"\" > ./Makefile ; $S_FP_NICE -n 5 makedepend *.c 2> /dev/null ; wait ; sync ; wait ; cat ./Makefile | grep -E '^[^ ]+: ' | $S_CMD_GNU_SED -e 's/[:]/ /g' | $S_CMD_GNU_SED -e 's/^/ /g' | $S_CMD_GNU_SED -e 's/\$/ /g' | $S_CMD_GNU_SED -e 's/ [\\/]usr[\\/][^ ]\\+/ /g' | $S_CMD_GNU_SED -e 's/[ ]\\+/ /g' | $S_CMD_GNU_SED -e 's/ \\+\$//g' | $S_CMD_GNU_SED -e 's/^[ ]\\+//g' | grep ' ' | $S_CMD_GNU_SED -e 's/\\([^ ]\\+\\)/\"\\1\"/g' | $S_CMD_GNU_SED -e 's/[ ]/ -> /g' | $S_CMD_GNU_SED -e 's/^/    /g' | $S_CMD_GNU_SED -e '1{s/^/digraph dependence_graph{\\n/g}' | $S_CMD_GNU_SED -e '\${s/\$/\\n\\}/g}' ; fi "
            fi
        fi
    fi
fi
        ...
        if [ "$SB_SED_EXISTS_ON_PATH" == "t" ]; then
            if [ "$SB_GREP_EXISTS_ON_PATH" == "t" ]; then
                if [ "$SB_CAT_EXISTS_ON_PATH" == "t" ]; then
                    ...
                    #         echo "GUID=='083ebf1e-cae2-45e6-b36c-a29090717ae7'" ;
                    #         echo "" ;
                    #     fi
                    # else
                    #     echo "" ;
...
if [ -e $S_FP ]; then
    if [ -d $S_FP ]; then
        ...
        #         fi ;
        #         echo "GUID=='4a3d6771-f4a6-4b7a-b75c-a29090717ae7'" ;
        #         echo "" ;
        #     fi ;
        # else
        #     if [ -h $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then
        ...
        #         echo "GUID=='2195f954-7e28-4a94-ba5c-a29090717ae7'" ;
        #         echo "" ;
        #     else
        #         echo "" ;
        ...
        #         echo "GUID=='052d5251-836a-46d0-b45c-a29090717ae7'" ;
        #         echo "" ;
        #     fi ;
        # fi
        #------------------------------------------------------------------
        # S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS="$HOME/.avfs" ; if [ -e $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then if [ -d $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_02_PWD="`pwd`" ; cd $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS/$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_02_PWD ; else echo "" ; echo "The path " ; echo "" ; echo "    $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS" ; echo "" ; if [ -h $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo -e "references a symlink to a file, but a\e[31m folder is expected\e[39m." ; else echo -e "references a file, but a\e[31m folder is expected\e[39m." ; fi ; echo "GUID=='6e9b9e13-6326-4a74-824c-a29090717ae7'" ; echo "" ; fi ; else if [ -h $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo "" ; echo "The path " ; echo "" ; echo "    $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS" ; echo "" ; echo -e "references a broken symlink, but a\e[31m folder is expected\e[39m." ; echo "GUID=='a6825717-a423-4b4e-b24c-a29090717ae7'" ; echo "" ; else echo "" ; echo "There is nothing at the path " ; echo "" ; echo "    $S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS" ; echo "" ; echo -e "but a\e[31m folder is expected\e[39m." ; echo "GUID=='506ddf65-63d2-45d1-ac4c-a29090717ae7'" ; echo "" ; fi ; fi
        #------------------------------------------------------------------
        S_TMP_0="S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS=\"$HOME/.avfs\" ; if [ -e \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then if [ -d \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_02_PWD=\"\`pwd\`\" ; cd \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS/\$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_02_PWD ; else echo \"\" ; echo \"The path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; if [ -h \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo -e \"references a symlink to a file, but a\\e[31m folder is expected\\e[39m.\" ; else echo -e \"references a file, but a\\e[31m folder is expected\\e[39m.\" ; fi ; echo \"GUID=='9ad98b4e-9e73-4137-924c-a29090717ae7'\" ; echo \"\" ; fi ; else if [ -h \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo \"\" ; echo \"The path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; echo -e \"references a broken symlink, but a\\e[31m folder is expected\\e[39m.\" ; echo \"GUID=='41b6d794-13fc-4712-824c-a29090717ae7'\" ; echo \"\" ; else echo \"\" ; echo \"There is nothing at the path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; echo -e \"but a\\e[31m folder is expected\\e[39m.\" ; echo \"GUID=='51a8dc05-0dc1-4d5b-b34c-a29090717ae7'\" ; echo \"\" ; fi ; fi"
        ...
        S_TMP_0="S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS=\"$HOME/.avfs\" ; if [ -e \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then if [ -d \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_02_PWD=\"\`pwd\`\" ; S_11=\"\$(pwd | sed -e 's/^[\\/]home[\\/]'\`whoami\`'[\\/][.]avfs//')\" ; cd \$S_11 ; else echo \"\" ; echo \"The path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; if [ -h \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo -e \"references a symlink to a file, but a\\e[31m folder is expected\\e[39m.\" ; else echo -e \"references a file, but a\\e[31m folder is expected\\e[39m.\" ; fi ; echo \"GUID=='9777b229-bd6a-4837-a24c-a29090717ae7'\" ; echo \"\" ; fi ; else if [ -h \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS ]; then echo \"\" ; echo \"The path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; echo -e \"references a broken symlink, but a\\e[31m folder is expected\\e[39m.\" ; echo \"GUID=='b3aea512-19ec-468b-833c-a29090717ae7'\" ; echo \"\" ; else echo \"\" ; echo \"There is nothing at the path \" ; echo \"\" ; echo \"    \$S_TMP_MMMV_USERSPACE_DISTRO_T1_ALIAS_CDAVFS_01_AVFS\" ; echo \"\" ; echo -e \"but a\\e[31m folder is expected\\e[39m.\" ; echo \"GUID=='9ccecb3a-d738-4f3f-833c-a29090717ae7'\" ; echo \"\" ; fi ; fi"
    ...
    if [ "$S_FP_VIM" != "" ]; then
        ...
        if [ -e "$S_TMP_0" ]; then
            if [ ! -d "$S_TMP_0" ]; then
                ...
                #         echo "GUID=='4fe7f815-42aa-455d-ac3c-a29090717ae7'" ;
                #         echo "" ;
                #     else
                #         echo "" ;
                ...
                #     echo "GUID=='2b278614-4814-4eee-993c-a29090717ae7'" ;
                #     echo "" ;
                # fi ;
                # sync &
                #----------------------------------------------------------
                # $S_FP_NICE -n 2 vim $S_TMP_0 ; wait ; S_ERR="$?" ; if [ "$S_ERR" == "0" ]; then sync ; wait ; i3-msg reload ; S_ERR="$?" ; if [ "$S_ERR" != "0" ]; then echo "" ; echo "Reloading of i3 configuration failed." ; echo -e "i3-msg exited with\e[31m error code $S_ERR\e[39m." ; echo "GUID=='a2ab1033-e561-4d0d-a23c-a29090717ae7'" ; echo "" ; else echo "" ; echo -e "\e[32mi3 window manager configuration reloaded\e[39m." ; echo "" ; fi ; else echo "" ; echo -e "Vim exited with\e[31m error code $S_ERR\e[39m." ; echo "Skipping i3 configuration file reloading." ; echo "GUID=='29aaa123-18d1-4d86-842c-a29090717ae7'" ; echo "" ; fi ; sync &
                #----------------------------------------------------------
                if [ "$SB_I3MSG_EXISTS_ON_PATH" == "t" ]; then
                    alias mmmv_vim_edit_i3_config_and_reload_it="$S_FP_NICE -n 2 vim $S_TMP_0 ; wait ; S_ERR=\"\$?\" ; if [ \"\$S_ERR\" == \"0\" ]; then sync ; wait ; i3-msg reload ; S_ERR=\"\$?\" ; if [ \"\$S_ERR\" != \"0\" ]; then echo \"\" ; echo \"Reloading of i3 configuration failed.\" ; echo -e \"i3-msg exited with\\e[31m error code \$S_ERR\\e[39m.\" ; echo \"GUID=='5cf73fc5-a999-412c-822c-a29090717ae7'\" ; echo \"\" ; else echo \"\" ; echo -e \"\\e[32mi3 window manager configuration reloaded\\e[39m.\" ; echo \"\" ; fi ; else echo \"\" ; echo -e \"Vim exited with\\e[31m error code \$S_ERR\\e[39m.\" ; echo \"Skipping i3 configuration file reloading.\" ; echo \"GUID=='64a22b17-15fd-4c0e-922c-a29090717ae7'\" ; echo \"\" ; fi ; sync &  "
                else
                    alias mmmv_vim_edit_i3_config="$S_FP_NICE -n 2 vim $S_TMP_0 ; wait ; S_ERR=\"\$?\" ; if [ \"\$S_ERR\" != \"0\" ]; then echo \"\" ; echo -e \"Vim exited with\\e[31m error code \$S_ERR\\e[39m.\" ; echo \"GUID=='7613da5f-5174-4a0d-922c-a29090717ae7'\" ; echo \"\" ; fi ; sync & "
                fi
                #----------------------------------------------------------
            fi
        fi
...
#==========================================================================
# S_VERSION_OF_THIS_FILE="5ba8503c-86f3-4039-b56c-a29090717ae7"
#==========================================================================
