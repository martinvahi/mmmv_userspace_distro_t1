...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='5ce23410-aa0b-4b37-b487-93234180a9e7'"
    echo ""
...
#     echo "GUID=='4fe7c95f-ae55-4924-a387-93234180a9e7'" ;
#     echo "" ;
# else
#     if [ -e $S_FP ]; then
#         if [ -d $S_FP ]; then
...
#             echo -e "exists, but it is expected to be missing or a file." ;
#             echo "Not deleting it. Aborting Bash alias." ;
#             echo "GUID=='a563c42f-ea44-4a78-9487-93234180a9e7'" ;
#             echo "" ;
#         else
#             if [ ! -r $S_FP ]; then
#                 echo "" ;
...
#                 echo "GUID=='40713905-e5b7-4f7c-aa87-93234180a9e7'" ;
#                 echo "" ;
#             else
#                 if [ ! -w $S_FP ]; then
#                     echo "" ;
...
#                     echo "GUID=='6404635c-efb2-469d-a487-93234180a9e7'" ;
#                     echo "" ;
#                 else
...
#                         echo "GUID=='5e6b7cb1-aa4d-459b-a487-93234180a9e7'" ;
#                         echo "" ;
#                     else
#                         rm $S_FP ;
#                         if [ "$?" != "0" ]; then
...
#                             echo "GUID=='804f2b49-1e66-4220-9587-93234180a9e7'" ;
#                             echo "" ;
#                         else
#                             sync ; wait ;
#                             if [ ! -e $S_FP ]; then
...
#                                 echo "GUID=='4fb984e3-4b5b-4288-b487-93234180a9e7'" ;
#                                 echo "" ;
#                             fi ;
#                         fi ;
#                     fi ;
...
#             echo "GUID=='5cce2085-5b9b-4f84-8387-93234180a9e7'" ;
#             echo "" ;
#         fi ;
#         sync ; wait ;
#     fi ;
...
#                 echo "GUID=='20093248-b1c1-4df1-b587-93234180a9e7'" ;
#             else
#                 echo "There is a symlink to a file with that path." ;
#                 echo "GUID=='4862ef54-8d1a-4f8f-8187-93234180a9e7'" ;
#             fi ;
#             echo "" ;
#         else
#             if [ -d $S_FP ]; then
...
#                 echo "GUID=='c32dc91d-5fdf-4734-8387-93234180a9e7'" ;
#                 echo "" ;
#             else
#                 chmod 0700 $S_FP ;
#                 sync ; wait ;
...
#             echo "GUID=='d8056d58-c144-4aa1-a487-93234180a9e7'" ;
#         else
#             echo "GUID=='4e2e4173-6a08-4609-a587-93234180a9e7'" ;
#         fi ;
#         echo "" ;
#     fi ;
# fi
...
# printf '<!DOCTYPE HTML>\n<html>\n<head>\n<title>ls</title>\n<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">\n<!-- MMMV_TAG_THIS_FILE_HAS_BEEN_AUTOGENERATED_T1 -->\n</head>\n<body id="the_document_body">\n<h1>ls</h1>\n<ul>\n    <li>\n        <a href="./../">..</a>\n    </li>\n' > $S_FP ; sync ; wait ; find . -maxdepth 1  -type d | grep -v -E '^[.]$' | $S_CMD_GNU_SED -e 's/^[.][\/]//g' | sort | $S_CMD_GNU_SED -e 's/\(^.\+$\)/    <li><a href=".\/\1\/">\1\/<\/a><\/li>/g' >> $S_FP ; sync ; wait ; find . -maxdepth 1 -type f | grep -i -v -E "$S_FN"'$' | $S_CMD_GNU_SED -e 's/^[.][\/]//g' | sort | $S_CMD_GNU_SED -e 's/\(^.\+$\)/    <li><a href=".\/\1">\1<\/a><\/li>/g' >> $S_FP ; sync ; wait ; printf '</ul>\n</body>\n</html>\n' >> $S_FP ;
# } ; if [ -h $S_FP ]; then echo "" ; if [ -e $S_FP ]; then if [ -d $S_FP ]; then echo -e "A\e[31m symlink to a folder \e[39m" ; else echo -e "A\e[31m symlink to a file \e[39m" ; fi ; else echo -e "A\e[31m broken symlink\e[39m" ; fi ; echo "" ; echo "    $S_FP" ; echo "" ; echo -e "exists, but it is expected to be missing or a file." ; echo "Not deleting it. Aborting Bash alias." ; echo "GUID=='40b403f4-ca16-403f-b287-93234180a9e7'" ; echo "" ; else if [ -e $S_FP ]; then if [ -d $S_FP ]; then echo "" ; echo -e "A\e[31m folder\e[39m with a path of " ; echo "" ; echo "    $S_FP" ; echo "" ; echo -e "exists, but it is expected to be missing or a file." ; echo "Not deleting it. Aborting Bash alias." ; echo "GUID=='3f2d39e3-8402-4c30-8487-93234180a9e7'" ; echo "" ; else if [ ! -r $S_FP ]; then echo "" ; echo "A file with a path of" ; echo "" ; echo "    $S_FP" ; echo "" ; echo -e "\e[31mis NOT readable\e[39m. Aborting Bash alias." ; echo "GUID=='42531524-bfc7-4146-b387-93234180a9e7'" ; echo "" ; else if [ ! -w $S_FP ]; then echo "" ; echo "A file with a path of" ; echo "" ; echo "    $S_FP" ; echo "" ; echo -e "\e[31mis NOT writable\e[39m. Aborting Bash alias." ; echo "GUID=='33d6ee82-f944-4d47-9287-93234180a9e7'" ; echo "" ; else S_TMP_0="`nice -n 2 cat $S_FP | grep ' MMMV_TAG_THIS_FILE_HAS_BEEN_AUTOGENERATED_T1 '`" ; if [ "$S_TMP_0" == "" ]; then echo "" ; echo "The file " ; echo "" ; echo "    $S_FP" ; echo "" ; echo -e "exists, but it\e[31m does not include the string \e[39m" ; echo -e "\"\e[31m MMMV_TAG_THIS_FILE_HAS_BEEN_AUTOGENERATED_T1 \e[39m\"." ; echo "Quotation marks around it are not required, but" ; echo "at least one space at each side of it is compulsory." ; echo "Not overwriting the file. Aborting Bash alias." ; echo "GUID=='10ea2c91-1a16-4643-b177-93234180a9e7'" ; echo "" ; else rm $S_FP ; if [ "$?" != "0" ]; then echo "" ; echo -e "\e[31mFailed to delete\e[39m the old version of the file" ; echo "" ; echo "    $S_FP" ; echo "" ; echo "Aborting Bash alias." ; echo "GUID=='3bb74223-dc4b-442e-8577-93234180a9e7'" ; echo "" ; else sync ; wait ; if [ ! -e $S_FP ]; then SB_GENERATE="t" ; else echo "" ; echo -e "\e[31mSomething went wrong\e[39m. The file " ; echo "" ; echo "    $S_FP" ; echo "" ; echo "still exists. Aborting Bash alias." ; echo "GUID=='5f9291dc-94cd-4153-8277-93234180a9e7'" ; echo "" ; fi ; fi ; fi ; fi ; fi ; fi ; else SB_GENERATE="t" ; fi ; fi ; if [ "$SB_GENERATE" == "t" ]; then if [ -e $S_FP ]; then chmod 0700 $S_FP ; if [ "$?" != "0" ]; then SB_GENERATE="f" ; echo "" ; echo -e "\e[31mFailed to change the permission of the file\e[39m" ; echo "" ; echo "    $S_FP" ; echo "" ; echo "to 0700 before trying to overwrite it. Aborting Bash alias." ; echo "GUID=='b5906553-54e3-4d4d-9277-93234180a9e7'" ; echo "" ; fi ; sync ; wait ; fi ; fi ; if [ "$SB_GENERATE" == "t" ]; then func_generate_HTML_without_verifying_anything  ; sync ; wait ; if [ -e $S_FP ]; then if [ -h $S_FP ]; then echo "" ; echo -e "\e[31mFailed to create or overwrite file\e[39m" ; echo "" ; echo "    $S_FP" ; echo "" ; if [ -d $S_FP ]; then echo "There is a symlink to a folder with that path." ; echo "GUID=='c9c2753f-d569-4443-8577-93234180a9e7'" ; else echo "There is a symlink to a file with that path." ; echo "GUID=='28e02eb7-873a-476d-9577-93234180a9e7'" ; fi ; echo "" ; else if [ -d $S_FP ]; then echo "" ; echo -e "\e[31mFailed to create or overwrite file\e[39m" ; echo "" ; echo "    $S_FP" ; echo "" ; echo "There is a folder with that path." ; echo "GUID=='2a5a7254-9c40-41bb-8e77-93234180a9e7'" ; echo "" ; else chmod 0700 $S_FP ; sync ; wait ; echo "" ; echo -e "\e[32mHTML generation complete\e[39m. The generated file:" ; echo "" ; echo "    $S_FP" ; echo "" ; fi ; fi ; else echo "" ; echo -e "\e[31mFailed to create or overwrite file\e[39m" ; echo "" ; echo "    $S_FP" ; echo "" ; if [ -h $S_FP ]; then echo "There is a broken symlink with that path." ; echo "GUID=='973e585e-0dbf-4287-b477-93234180a9e7'" ; else echo "GUID=='f2603635-1484-4710-b277-93234180a9e7'" ; fi ; echo "" ; fi ; fi
...
S_BASHALIASCODE_SUFFIX=" } ; if [ -h \$S_FP ]; then echo \"\" ; if [ -e \$S_FP ]; then if [ -d \$S_FP ]; then echo -e \"A\\e[31m symlink to a folder \\e[39m\" ; else echo -e \"A\\e[31m symlink to a file \\e[39m\" ; fi ; else echo -e \"A\\e[31m broken symlink\\e[39m\" ; fi ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo -e \"exists, but it is expected to be missing or a file.\" ; echo \"Not deleting it. Aborting Bash alias.\" ; echo \"GUID=='0003852e-3a4a-45e1-a377-93234180a9e7'\" ; echo \"\" ; else if [ -e \$S_FP ]; then if [ -d \$S_FP ]; then echo \"\" ; echo -e \"A\\e[31m folder\\e[39m with a path of \" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo -e \"exists, but it is expected to be missing or a file.\" ; echo \"Not deleting it. Aborting Bash alias.\" ; echo \"GUID=='4c34f157-80e4-4b97-8477-93234180a9e7'\" ; echo \"\" ; else if [ ! -r \$S_FP ]; then echo \"\" ; echo \"A file with a path of\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo -e \"\\e[31mis NOT readable\\e[39m. Aborting Bash alias.\" ; echo \"GUID=='ffa8222b-35f0-4a2c-8377-93234180a9e7'\" ; echo \"\" ; else if [ ! -w \$S_FP ]; then echo \"\" ; echo \"A file with a path of\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo -e \"\\e[31mis NOT writable\\e[39m. Aborting Bash alias.\" ; echo \"GUID=='77837d55-49bc-4ea6-8177-93234180a9e7'\" ; echo \"\" ; else S_TMP_0=\"\`nice -n 2 cat \$S_FP | grep ' MMMV_TAG_THIS_FILE_HAS_BEEN_AUTOGENERATED_T1 '\`\" ; if [ \"\$S_TMP_0\" == \"\" ]; then echo \"\" ; echo \"The file \" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo -e \"exists, but it\\e[31m does not include the string \\e[39m\" ; echo -e \"\\\"\\e[31m MMMV_TAG_THIS_FILE_HAS_BEEN_AUTOGENERATED_T1 \\e[39m\\\".\" ; echo \"Quotation marks around it are not required, but\" ; echo \"at least one space at each side of it is compulsory.\" ; echo \"Not overwriting the file. Aborting Bash alias.\" ; echo \"GUID=='5e120fb4-be95-4b85-a677-93234180a9e7'\" ; echo \"\" ; else rm \$S_FP ; if [ \"\$?\" != \"0\" ]; then echo \"\" ; echo -e \"\\e[31mFailed to delete\\e[39m the old version of the file\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo \"Aborting Bash alias.\" ; echo \"GUID=='17e69940-defe-4b08-b277-93234180a9e7'\" ; echo \"\" ; else sync ; wait ; if [ ! -e \$S_FP ]; then SB_GENERATE=\"t\" ; else echo \"\" ; echo -e \"\\e[31mSomething went wrong\\e[39m. The file \" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo \"still exists. Aborting Bash alias.\" ; echo \"GUID=='3d8d0c27-8809-4670-b177-93234180a9e7'\" ; echo \"\" ; fi ; fi ; fi ; fi ; fi ; fi ; else SB_GENERATE=\"t\" ; fi ; fi ; if [ \"\$SB_GENERATE\" == \"t\" ]; then if [ -e \$S_FP ]; then chmod 0700 \$S_FP ; if [ \"\$?\" != \"0\" ]; then SB_GENERATE=\"f\" ; echo \"\" ; echo -e \"\\e[31mFailed to change the permission of the file\\e[39m\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo \"to 0700 before trying to overwrite it. Aborting Bash alias.\" ; echo \"GUID=='a5cd3b56-b7eb-4d68-9177-93234180a9e7'\" ; echo \"\" ; fi ; sync ; wait ; fi ; fi ; if [ \"\$SB_GENERATE\" == \"t\" ]; then func_generate_HTML_without_verifying_anything  ; sync ; wait ; if [ -e \$S_FP ]; then if [ -h \$S_FP ]; then echo \"\" ; echo -e \"\\e[31mFailed to create or overwrite file\\e[39m\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; if [ -d \$S_FP ]; then echo \"There is a symlink to a folder with that path.\" ; echo \"GUID=='6513e9d8-697c-4a20-ba77-93234180a9e7'\" ; else echo \"There is a symlink to a file with that path.\" ; echo \"GUID=='c868675a-1607-4b37-a577-93234180a9e7'\" ; fi ; echo \"\" ; else if [ -d \$S_FP ]; then echo \"\" ; echo -e \"\\e[31mFailed to create or overwrite file\\e[39m\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; echo \"There is a folder with that path.\" ; echo \"GUID=='1db0c4c4-44fc-4273-9577-93234180a9e7'\" ; echo \"\" ; else chmod 0700 \$S_FP ; sync ; wait ; echo \"\" ; echo -e \"\\e[32mHTML generation complete\\e[39m. The generated file:\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; fi ; fi ; else echo \"\" ; echo -e \"\\e[31mFailed to create or overwrite file\\e[39m\" ; echo \"\" ; echo \"    \$S_FP\" ; echo \"\" ; if [ -h \$S_FP ]; then echo \"There is a broken symlink with that path.\" ; echo \"GUID=='1a58fe51-a9b3-4f62-a377-93234180a9e7'\" ; else echo \"GUID=='f0fdbe42-689b-4284-8177-93234180a9e7'\" ; fi ; echo \"\" ; fi ; fi "
#--------------------------------------------------------------------------
...
#==========================================================================
# S_VERSION_OF_THIS_FILE="744c07ef-7086-433a-8587-93234180a9e7"
#==========================================================================
