...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='9e8a1635-2874-4fbc-8296-3102600178e7'"
    echo ""
...
if [ ! -e "$PYTHONUSERBASE" ]; then
    ...
    if [ ! -e "$PYTHONUSERBASE" ]; then
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" != "f" ]; then
            ...
            echo "GUID=='6a796e64-81b6-4081-8696-3102600178e7'"
            echo ""
        fi
    fi
fi
...
func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
    "$PYTHONUSERBASE" "65576616-5315-4d97-a596-3102600178e7" \
...
if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
    ...
    func_mmmv_verify_that_the_folder_exists_but_do_not_exit_t1 \
        "$S_FP_0" "2a543fff-a0cc-4f23-a196-3102600178e7" \
        "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
    if [ "$SB_VERIFICATION_FAILED" == "f" ]; then
...
#==========================================================================
# S_VERSION_OF_THIS_FILE="b268fd1b-a7ec-4bef-9496-3102600178e7"
#==========================================================================
