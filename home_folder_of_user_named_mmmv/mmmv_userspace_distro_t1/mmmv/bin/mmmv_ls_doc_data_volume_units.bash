...
if [ -e "$S_FP_IBM_PRODUCT_MANUAL_PDF" ]; then
    if [ -d "$S_FP_IBM_PRODUCT_MANUAL_PDF" ]; then
        ...
        echo "GUID=='9c48dfaf-372c-4e57-b978-e2d1619038e7'"
        echo ""
        exit 1 
    else
...
func_display_doc() {
    ...
    echo ""
    echo "GUID=='56218541-e4f8-40d0-9948-e2d1619038e7'"
    echo ""
    #--------------------
} # func_display_doc
...
exit 0 
#==========================================================================
# S_VERSION_OF_THIS_FILE="13d30b31-9449-4899-9818-e2d1619038e7"
#==========================================================================
